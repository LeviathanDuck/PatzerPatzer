...
- [x] CCP-603 - Study Sprint Post-Review Bug Fix Manager
- [x] CCP-599 - Fix 3 post-review bugs: PGN data loss on auto-save, move-wrap layout regression, dead stub in libraryView
- [x] CCP-600 - Fix annotation panel: Cancel saves instead of discards, wrong comment shown
- [x] CCP-601 - Fix study detail: navigating between studies shows wrong study
- [x] CCP-602 - Fix glyph quick-select CSS positioning: missing position:relative on board column
- [x] CCP-562 - Opening Classification Sprint Manager
- [x] CCP-518 - Add IDB Eco Index And Opening Filter In Games Tab
- [x] CCP-517 - Backfill Existing Games And Wire Openings Research Import
- [x] CCP-516 - Wire Opening Classification Into Game Import Paths
- [x] CCP-515 - Create ECO Classifier Module
- [x] CCP-306 - Review Rated Ladder Cloud Ownership And Sync
- [x] CCP-305 - Add Client Push Pull And Merge For Rated Puzzle Data
- [x] CCP-304 - Add Server Sync Contracts For Rated Puzzle Perf And History
- [x] CCP-303 - Extend Lichess Auth Identity Seam For Rated Puzzle Ownership
- [x] CCP-302 - Add User Scoped Server Schema For Rated Puzzle Perf And History
- [x] CCP-301 - Rated Ladder Cloud Ownership Batch Manager
- [x] CCP-300 - Review Rated Ladder UI Surfaces
- [x] CCP-299 - Add Current User Rating And Round Rating Diff UI
- [x] CCP-298 - Add Casual Only Messaging For Repeated Solved Puzzles
- [x] CCP-297 - Add Rated Assistance Warning Modal And Remember Choice UI
- [x] CCP-296 - Add Rated Practice And Difficulty UI Surfaces
- [x] CCP-295 - Rated Ladder UI Batch Manager
- [x] CCP-294 - Review Rated Completion And Rating Updates
- [x] CCP-293 - Write Rating Snapshots And History On Rated Completion
- [x] CCP-292 - Wire Rated Failure Completion Path
- [x] CCP-291 - Wire Rated Success Completion Path
- [x] CCP-290 - Add User Only Rating Calculator Service
- [x] CCP-289 - Rated Ladder Completion And Rating Batch Manager
- [x] CCP-288 - Review Rated Eligibility And Selection
- [x] CCP-287 - Add Rating Aware Selection With Difficulty Offsets
- [x] CCP-286 - Add Recent Failed One Week Rated Exclusion Rule
- [x] CCP-285 - Add Previously Solved Casual Only Rated Rule
- [x] CCP-284 - Add Imported Only Rated Source Gating
- [x] CCP-283 - Rated Ladder Eligibility And Selection Batch Manager
- [x] CCP-282 - Review Rated Session Policy And Assistance Flow
- [x] CCP-281 - Wire Stay Rated Immediate Fail Assistance Branch
- [x] CCP-280 - Wire Cancel And Switch To Casual Assistance Branches
- [x] CCP-279 - Add Assistance Warning State And Session Memory
- [x] CCP-278 - Add Rated Practice Session Owner
- [x] CCP-277 - Rated Ladder Session Policy Batch Manager
- [x] CCP-276 - Review Local Rated Ladder Persistence
- [x] CCP-275 - Wire Local Perf And History Restore Seams
- [x] CCP-274 - Persist Rated Attempt Snapshots And Outcome Metadata
- [x] CCP-273 - Persist Rating History In Puzzle DB
- [x] CCP-272 - Persist User Puzzle Perf In Puzzle DB
- [x] CCP-271 - Rated Ladder Local Persistence Batch Manager
- [x] CCP-270 - Review Local Rated Ladder Domain Types
- [x] CCP-269 - Add Difficulty Offset Domain Types And Constants
- [x] CCP-268 - Add Rated Eligibility And Outcome Domain Types
- [x] CCP-267 - Add Rating History And Round Delta Domain Types
- [x] CCP-266 - Add Canonical User Puzzle Perf Types
- [x] CCP-265 - Rated Ladder Local Domain Batch Manager
- [x] CCP-264 - Review Rated Ladder Research And Ownership Grounding
- [x] CCP-263 - Write Rated Ladder Implementation Map And File Ownership Plan
- [x] CCP-262 - Audit Current Patzer Auth Sync And Server Ownership Seams
- [x] CCP-261 - Audit Current Patzer Puzzle Runtime And Ownership Seams
- [x] CCP-260 - Recheck Lichess Puzzle Rating Audit Against Upstream Source
- [x] CCP-259 - Rated Ladder Research And Parity Batch Manager
- [x] CCP-258 - Rated Puzzle Ladder Full Sprint Batch Manager
...
- [x] CCP-165 - Save Learn From Your Mistakes Moments Into User Library
- [x] CCP-163 - Render Eval-Delta Feedback For Non-Best Moves
- [x] CCP-162 - Log Assisted-Solve And Reveal Reasons
- [x] CCP-161 - Add PuzzleMoveQuality Evaluation Layer
- [x] CCP-160 - Add Puzzle-Mode Engine Runtime Owner
- [x] CCP-158 - Render Puzzle Result States And Navigation
- [x] CCP-157 - Persist Puzzle Attempt Results
- [x] CCP-156 - Validate Strict Solution Moves And Auto-Reply
- [x] CCP-155 - Add Puzzle Round Controller
...
- [x] CCP-143 - Add Board Consumer Move Hook
- [x] CCP-144 - Move Retrospection Solve Logic Out Of Board Core
- [x] CCP-145 - Add Canonical Puzzle Domain Types
- [x] CCP-146 - Add Puzzle Library Persistence Owner
- [x] CCP-147 - Add Puzzle Source Adapter Seams
...
- [x] CCP-253 - Adopt Shared MoveNavBar In Puzzle Round
- [x] CCP-254 - Add Puzzle Round Action Menu And Book Toggle
- [x] CCP-255 - Add In-Place Preview Mode To Puzzle Library
- [x] CCP-256 - Add Puzzle Library Preview Action Menu And Book Toggle
- [x] CCP-257 - Chess Board Standard Rollout Batch Manager
- [x] CCP-307 - Rated Puzzle Stream Full Sprint Batch Manager
- [x] CCP-308 - Rated Stream Research And Implementation Map Batch Manager
- [x] CCP-309 - Audit Lichess Puzzle Stream Selection Source
- [x] CCP-310 - Audit selectNextRatedPuzzle IDB-Only Gap
- [x] CCP-311 - Write Rated Stream Implementation Map
- [x] CCP-312 - Shard Loader Integration Batch Manager
- [x] CCP-313 - Add findRatedPuzzleFromShards To puzzleDb
- [x] CCP-314 - Wire Shard Fallback Into selectNextRatedPuzzle
- [x] CCP-315 - Controller And UI Wiring Batch Manager
- [x] CCP-316 - Add startRatedSession And Stream State To ctrl
- [x] CCP-317 - Add Rated Stream Left-Panel Entry Card To view
- [x] CCP-318 - Wire Auto-Advance On Rated Round Completion
- [x] CCP-319 - Styles And Integration Review Batch Manager
...
- [x] CCP-328 - Audit Current Opponent Analytics Seams From Imported Research Data
- [x] CCP-329 - Audit Current Board Engine And Practice Seams For Practice Against Them
- [x] CCP-330 - Grounding And Implementation Map Review
- [x] CCP-332 - Add Canonical Openings Tool Types And Session Tool State
- [x] CCP-333 - Add Active Tool Selection Accessors And Reset Rules
- [x] CCP-334 - Render Persistent Left Tool Rail In The Openings Session
- [x] CCP-335 - Refactor The Session Main Content To Active Tool Takeover Layout
- [x] CCP-336 - Extract The Current Session Experience Into A Dedicated Repertoire Tool Owner
- [x] CCP-337 - Persist Active Tool Selection In Openings Session Resume State
- [x] CCP-338 - Tool Shell And Mode Architecture Review
- [x] CCP-340 - Add Canonical Opponent Analytics Types And Dashboard Section Models
- [x] CCP-341 - Add Base Collection Analytics Loader From Imported Research Games
- [x] CCP-342 - Add Repertoire Breadth Predictability And Opening Concentration Metrics
- [x] CCP-343 - Add Recency And Form Analytics From Imported Opponent Game History
- [x] CCP-344 - Add Prep Report Analytics Summaries From Current Collection History
- [x] CCP-345 - Add Opponent Analytics Cache And Controller Owner Seam
- [x] CCP-346 - Opponent Analytics Foundation Review
- [x] CCP-348 - Render Repertoire As A First Class Full Page Tool
- [x] CCP-349 - Add Repertoire Overview Dashboard Section Above The Tree Experience
- [x] CCP-350 - Add Repertoire Summary Modules For Perspective Speed And Recency
- [x] CCP-351 - Add Line Insight Cards Tied To Practical Opponent Prep Signals
- [x] CCP-352 - Strengthen Sample Game And Current Position Interplay Inside Repertoire
- [x] CCP-353 - Polish Repertoire Full Page Interaction Coherence
- [x] CCP-354 - Repertoire Tool Review
- [x] CCP-356 - Add Canonical Prep Report Section Model And View Owner
- [x] CCP-357 - Derive Likely Lines And Expected Repertoire Modules
- [x] CCP-358 - Derive Targetable Weaknesses And Practical Prep Notes
- [x] CCP-359 - Render Prep Report As A Full Page Openings Tool Dashboard
- [x] CCP-360 - Add Interactive Likely Line And Target Line Modules To Prep Report
- [x] CCP-361 - Add Actionable Prep Cards And Opponent Plan Summary Modules
- [x] CCP-362 - Prep Report Review
- [x] CCP-364 - Add Style Profile Synthesis Model And Owner Seam
- [x] CCP-365 - Derive Style Axes From Repertoire Results And Predictability Analytics
- [x] CCP-366 - Derive Recent Form Stability And Volatility Signals For Style
- [x] CCP-367 - Render Style As A Full Page Openings Tool Dashboard
- [x] CCP-368 - Add Player Card Archetype And Style Axis Modules
- [x] CCP-369 - Add Form Stability And Behavioral Tendency Modules To Style
- [x] CCP-370 - Style Dashboard Review
- [x] CCP-372 - Recheck Practice Against Opponent Seams And Closest References
- [x] CCP-373 - Add Practice Against Them Session Types And Controller Ownership
- [x] CCP-374 - Add Opponent Repertoire Move Selection Service From Opening Tree Data
- [x] CCP-375 - Add Honest Engine Handoff Policy After Repertoire Confidence Is Exhausted
- [x] CCP-376 - Render Practice Against Them As A Full Page Board Led Tool Surface
- [x] CCP-377 - Wire Practice Session Controls Board Flow And Phase Transitions
- [x] CCP-378 - Practice Against Them And Tool Suite Integration Review
- [x] CCP-379 - Enable Clock Data On Lichess Import
- [x] CCP-380 - Add GameSummary Type And Persistence
- [x] CCP-381 - Extract GameSummary From Analyzed Games
- [x] CCP-382 - Backfill Missing GameSummaries
- [x] CCP-383 - Add Stats Controller And Route Wiring
- [x] CCP-384 - Build Weakness Aggregation Engine
- [x] CCP-385 - Add Stats Weakness Panel
- [x] CCP-386 - Add Accuracy And Blunder Trend Charts
- [x] CCP-387 - Add Opening Performance Table
- [x] CCP-388 - Add Tactical Profile Section
- [x] CCP-389 - Add Post Game Summary Panel
- [x] CCP-390 - Persist Retro Session Results
- [x] CCP-391 - Add Weakness Training Actions
- [x] CCP-392 - Add Time Management Profile Section
- [x] CCP-393 - Add Conversion And Resourcefulness Metrics
- [x] CCP-394 - Improvement Intelligence Quick Wins Batch Manager
- [x] CCP-395 - Improvement Intelligence Foundation Spine Batch Manager
- [x] CCP-396 - Improvement Intelligence Weakness Engine Batch Manager
- [x] CCP-397 - Improvement Intelligence Stats Surfaces Batch Manager
- [x] CCP-398 - Improvement Intelligence Platform Full Sprint Batch Manager
- [x] CCP-399 - Rename Opponents Route In Router
- [x] CCP-400 - Rename Opponents Navigation In Header
- [x] CCP-401 - Rename Opponents Route Handling In Main
- [x] CCP-402 - Rename Opponent Research Titles In View
- [x] CCP-403 - Rename Opponent Research Empty State And Menu Copy
- [x] CCP-404 - Extract Rating Series For Opponent Sparklines
- [x] CCP-405 - Render Opponent Rating Sparkline SVG
- [x] CCP-406 - Add Peak Current And Trend Indicators To Sparklines
- [x] CCP-407 - Integrate Sparklines Into Collection Cards
- [x] CCP-408 - Normalize Termination Headers Into A Termination Profile
- [x] CCP-409 - Extract Opponent Game Length Profile
- [x] CCP-410 - Render Prep Report Termination Cards
- [x] CCP-411 - Render Prep Report Game Length Cards
- [x] CCP-412 - Define Deviation Point Types And Scan Contract
- [x] CCP-413 - Walk The Opponent Tree For Deviation Candidates
- [x] CCP-414 - Add Explorer Comparison Adapter For Deviation Detection
- [x] CCP-415 - Add Deviation Scan Rate Limit And Cache
- [x] CCP-416 - Add Progressive Async Deviation Scan Results
- [x] CCP-417 - Add Deviation Markers To Opponent Move Rows
- [x] CCP-418 - Add Theory Deviations Summary Panel
- [x] CCP-419 - Add Deviation Scan State To Openings Controller
- [x] CCP-420 - Add Manual Deviation Scan Trigger And Progress UI
- [x] CCP-421 - Define Opening Recommendation Types And Confidence Rules
- [x] CCP-422 - Compute Opening Recommendations From Weakness Data
- [x] CCP-423 - Add Recommendation Navigation Targets
- [x] CCP-424 - Render Recommended Preparation Cards
- [x] CCP-425 - Define Trap Pattern Types And Threshold Rules
- [x] CCP-426 - Detect Repeated Loss Trap Patterns
- [x] CCP-427 - Rank Trap Patterns By Severity And Traplikeness
- [x] CCP-428 - Render Vulnerable Positions Section
- [x] CCP-429 - Add Vulnerable Position Navigation Hooks
- [x] CCP-430 - Add Sample Size Labels To Opponent Percentages
- [x] CCP-431 - Add Small Collection Warning Badges
- [x] CCP-432 - Add Prep Report Small Sample Banner
- [x] CCP-433 - Deemphasize Unreliable Opponent Stats
- [x] CCP-434 - Add Recency Mode State To Opponent Research
- [x] CCP-435 - Make Recency Weighted Ordering The Default
- [x] CCP-436 - Add Recent First Toggle To Prep Report
- [x] CCP-437 - Add Recency Auto Fallback Logic
- [x] CCP-438 - Render Recency Fallback Notice
- [x] CCP-439 - Add SavedVariation Type For Training
- [x] CCP-440 - Add Training Variations Store To Openings DB
- [x] CCP-441 - Add Saved Variation DB Helpers
- [x] CCP-442 - Add Save To Training In Repertoire Move List
- [x] CCP-443 - Add Save To Training In Likely Lines
- [x] CCP-444 - Add Save To Training In Target Lines
- [x] CCP-445 - Add Saved Confirmation UX For Training Variations
- [x] CCP-446 - Research Low Depth Opponent Collection Analysis Feasibility
- [x] CCP-447 - Research Opponent Clock Data Extraction Feasibility
- [x] CCP-448 - Review Opponent Research Platform Sprint Integration
- [x] CCP-449 - Opponent Research Rename And Shell Batch Manager
- [x] CCP-450 - Opponent Research Sparkline And Honesty Batch Manager
- [x] CCP-451 - Opponent Research Termination And Recommendations Batch Manager
- [x] CCP-452 - Opponent Research Deviation Scan Batch Manager
- [x] CCP-453 - Opponent Research Traps And Recency Batch Manager
- [x] CCP-454 - Opponent Research Training Variation Batch Manager
- [x] CCP-455 - Opponent Research Feasibility Research Batch Manager
- [x] CCP-456 - Opponent Research Implementation Batch Manager
- [x] CCP-457 - Opponent Research Platform Full Sprint Batch Manager
- [x] CCP-458 - Fix exactOptionalPropertyTypes Violations In openings/view.ts
- [x] CCP-459 - Fix exactOptionalPropertyTypes Violations In openings/import.ts
- [x] CCP-460 - Fix exactOptionalPropertyTypes Violations In openings/analytics.ts
- [x] CCP-461 - Fix exactOptionalPropertyTypes Violations In puzzles/ctrl.ts
- [x] CCP-462 - Fix Typecheck Failures In main.ts From Analysis Controls Migration
- [x] CCP-463 - Wire Rated Puzzle Cloud Sync Into Runtime
- [x] CCP-464 - Remove Retro Lifecycle Hook Dead Code
- [x] CCP-465 - Wire Book-Aware Cancellation Into Retro Flow
- [x] CCP-466 - Fix Sync Pull To Write Puzzle Attempts To IndexedDB
- [x] CCP-467 - Remove Legacy analyse__actions Render Path From main.ts
- [x] CCP-468 - Fix Deviation Markers To Render In Move Rows
- [x] CCP-469 - Fix Save-Puzzle Inconsistent Definition Creation
- [x] CCP-470 - Fix Bulk-Save To Preserve First-Attempt Outcome Info
- [x] CCP-471 - Move findRatedPuzzleFromShards To puzzleDb.ts
- [x] CCP-472 - Migrate Server DB From MySQL To SQLite
- [x] CCP-473 - Sprint Audit Fix-All Batch Manager
- [x] CCP-474 - Performance Audit Full Batch Manager
- [x] CCP-475 - Fix Sync IDB Version Mismatch
- [x] CCP-476 - Add 200ms Engine Update Throttle
- [x] CCP-477 - rAF-Gate the Redraw Function
- [x] CCP-478 - Throttle Wheel-Scroll Redraws
- [x] CCP-479 - Increase Lichess Import Max
- [x] CCP-480 - Add NNUE Prefetch Hint
- [x] CCP-481 - Request Persistent Storage
- [x] CCP-482 - Cache filteredSummaries Result
- [x] CCP-483 - Cache Game Summaries in Stats Controller
- [x] CCP-484 - Phase 1 Critical Quick Fixes Batch Manager
- [x] CCP-485 - Add Per-Game IDB Store Schema
- [x] CCP-486 - Migrate Game Save Path to Per-Game Records
- [x] CCP-487 - Migrate Game Load Path to On-Demand Reads
- [x] CCP-488 - Update Deduplication to Composite Keys
- [x] CCP-489 - Update Sync Client for Per-Game Records
- [x] CCP-490 - Phase 2 Game Library Restructure Batch Manager
- [x] CCP-491 - Replace listPuzzleDefinitions getAll with Cursor
- [x] CCP-492 - Batch Retry Queue Construction
- [x] CCP-493 - Add Puzzle Attempt Retention Policy
- [x] CCP-494 - Deduplicate Puzzle Attempts on Pull
- [x] CCP-495 - Cap Shard Cache with LRU Eviction
- [x] CCP-496 - Phase 3 Puzzle Subsystem Scaling Batch Manager
- [x] CCP-497 - Batch Server Game Inserts
- [x] CCP-498 - Batch Server Analysis and Puzzle Inserts
- [x] CCP-499 - Add updatedAt Tracking for Differential Sync
- [x] CCP-500 - Implement Server-Side Since Parameter
- [x] CCP-501 - Update Sync Client for Differential Push/Pull
- [x] CCP-502 - Phase 4 Server & Sync Hardening Batch Manager
- [x] CCP-503 - Add Game List Pagination
- [x] CCP-504 - Add Skeleton UI for Route Loading
- [x] CCP-505 - Add Import Progress Counter
- [x] CCP-506 - Remove Unused Stockfish Directory
- [x] CCP-507 - Phase 5 UI Responsiveness Batch Manager
- [x] CCP-510 - Rename Repertoire Tool to Opening Tree in Session Toolbar
- [x] CCP-509 - Fix Stuck Importing Dialogue After Returning to Library
- [x] CCP-508 - Fix Time Control Classification Thresholds
- [x] CCP-470-F1 - Fix Bulk-Save Puzzle Flow — Preserve First-Attempt Outcomes
- [x] CCP-471-F1 - Move findRatedPuzzleFromShards to puzzleDb.ts
- [x] CCP-511 - Openings Opponent Tool Suite Batch Manager
- [x] CCP-512 - Fix Engine Section Position on Opening Tree Page
- [x] CCP-513 - Color Toggle Buttons Show Username When Active
...
- [x] CCP-524 - Context menu — Save to Library
- [x] CCP-525 - Board menu — Save game to Library
- [x] CCP-526 - Toast notification system
- [x] CCP-527 - Phase 1 Manager — Save Action — Save to Library from Anywhere
- [x] CCP-528 - Study library controller
- [x] CCP-529 - Library list view
- [x] CCP-530 - Study metadata editing
- [x] CCP-531 - PGN import to library
- [x] CCP-532 - Phase 2 Manager — Study Library Browser
- [x] CCP-533 - Study detail page shell with board
- [x] CCP-534 - Text comment editing
- [x] CCP-535 - NAG glyph insertion
- [x] CCP-536 - Variation creation and management
- [x] CCP-537 - Variation fold/expand
- [x] CCP-538 - Arrow and shape persistence
- [x] CCP-539 - Engine analysis in study workspace
- [x] CCP-540 - Position bookmarking
- [x] CCP-541 - Auto-save and PGN export
- [x] CCP-542 - Phase 3 Manager — Study Detail — Annotation Workspace
- [x] CCP-543 - Scheduling engine
- [x] CCP-544 - Move grader
- [x] CCP-545 - Drill session controller
...
- [x] CCP-565 - Strength Types And UCI Integration Phase Manager
- [x] CCP-566 - Audit SF18 WASM UCI Options For Strength Limiting
- [x] CCP-567 - Define EngineMode EngineStrengthConfig And STRENGTH_LEVELS
- [x] CCP-568 - Add Play Mode UCI Methods To StockfishProtocol
- [x] CCP-569 - Phase 1 Build And Typecheck Validation
- [x] CCP-571 - Engine Mode Switching Phase Manager
- [x] CCP-572 - Trace Engine Lifecycle And Mode Switch Injection Points
- [x] CCP-573 - Add EngineMode EnterPlayMode ExitPlayMode To Ctrl
- [x] CCP-574 - Persist Last Used Strength Level In LocalStorage
- [x] CCP-575 - Phase 2 Build Typecheck And Console Validation
- [x] CCP-577 - Play Move Service Phase Manager
- [x] CCP-578 - Design Bestmove Routing For Play Mode
- [x] CCP-579 - Implement RequestPlayMove And CancelPlayMove
- [x] CCP-580 - Add PlayMoveWithDelay Utility
- [x] CCP-581 - Phase 3 Build Typecheck And Console Integration Test
- [x] CCP-582 - Practice Against Them Integration Phase Manager
- [x] CCP-583 - Add StrengthLevel To PracticeSession Type
- [x] CCP-584 - Wire RequestPlayMove Into Practice Engine Branch
- [x] CCP-585 - Update Practice Banner To Show Strength Level
- [x] CCP-586 - Phase 4 End To End Validation
- [x] CCP-587 - Strength Selector UI Phase Manager
- [x] CCP-588 - Audit Lichess AI Level Selector UI Pattern
- [x] CCP-589 - Create RenderStrengthSelector View Function
- [x] CCP-590 - Embed Strength Selector In Practice Setup Panel
- [x] CCP-591 - Add Strength Selector Styling
- [x] CCP-592 - Phase 5 Visual And Functional Validation
- [x] CCP-593 - Fix retro move feedback lost after offTrack state
- [x] CCP-594 - Audit Learn from your mistakes moment selection against Lichess
- [x] CCP-595 - Eval diff for retro move quality — batch manager
...
## CCP-603 - Study Sprint Post-Review Bug Fix Manager
...
- [x] Reviewed
  ...
  - Batch prompt IDs: `CCP-600`, `CCP-601`, `CCP-602`
  - Source document: `Line-by-line review of Study Sprint (CCP-522–CCP-563)`
  - Source step: `Post-review bug fix manager`
  - Task: Execute CCP-600, CCP-601, CCP-602 in order to fix all bugs found during study sprint line-by-line review
  ...
  - Review issues: none
  - Reviewed at: `2026-04-01T17:39:16.905Z`
  - Reviewed by: `Codex`
  ...
  - Manual checklist:
    - [ ] Cancel button in comment panel does not save (CCP-600)
    - [ ] Navigating between studies loads the correct study (CCP-601)
    - [ ] Glyph quick-select appears over the board (CCP-602)
```

## CCP-599 - Fix 3 post-review bugs: PGN data loss on auto-save, move-wrap layout regression, dead stub in libraryView
...
- [x] Reviewed
  ...
  - Task: Fix persistStudy() PGN data loss, move-wrap display:contents layout fix, remove renderStudyDetail stub from libraryView.ts
  - Created by: `Claude Code`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:38:59.262Z`
  - Reviewed by: `Codex`
  ...
  - Manual checklist:
    - [ ] Open a study, add a comment and a glyph annotation to a move, navigate away and back — confirm comment and glyph are still present after reload
    - [ ] Add an arrow shape on the board in study mode, save and reload — confirm arrow is preserved
    - [ ] Open two different studies via #/study/A and #/study/B — confirm each shows the correct study (requires CCP-601 fix)
    - [ ] Open analysis board, right-click a move, click Save to Library — confirm entry appears in #/study
    - [ ] In move list with bookmarks enabled, verify bookmark buttons sit in the correct column position (no layout overflow from move-wrap)
```

## CCP-600 - Fix annotation panel: Cancel saves instead of discards, wrong comment shown
...
- [x] Reviewed
  ...
  - Source step: `Post-review fixes`
  - Task: Fix blur/cancel race in comment panel and wrong comment display by index vs id
  - Created by: `Claude Code`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:39:04.747Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open a study, navigate to a move, click '+ Add comment', type text, click Cancel — confirm comment is NOT saved
    - [ ] Add a comment to a move, save, reload study — confirm the correct comment text displays (not a PGN comment from another slot)
    - [ ] Add a comment via Enter key — confirm it saves correctly
```

## CCP-601 - Fix study detail: navigating between studies shows wrong study
...
- [x] Reviewed
  ...
  - Source step: `Post-review fixes`
  - Task: Fix renderStudyDetail not reloading when study ID changes
  - Created by: `Claude Code`
  - Created at: `2026-03-31T22:30:00.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:39:11.303Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open #/study, open study A, navigate to #/study — confirm library loads
    - [ ] From library, open study A, then click back and open study B — confirm study B's title and moves load (not study A's)
    - [ ] Directly navigate to #/study/B after having viewed study A — confirm correct study appears
```

## CCP-602 - Fix glyph quick-select CSS positioning: missing position:relative on board column
...
- [x] Reviewed
  ...
  - Source step: `Post-review fixes`
  - Task: Add position:relative to .study-detail__board-col so glyph-quick-select absolute positioning works
  - Created by: `Claude Code`
  - Created at: `2026-03-31T22:30:00.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:38:26.818Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open a study, focus the board column, press ! or ? — confirm the glyph quick-select popup appears overlaid on the board area (not in a corner of the viewport or off-screen)
```
...
- [x] Reviewed
  ...
  - Task ID: `CCP-562`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-515`, `CCP-516`, `CCP-517`, `CCP-518`
  - Source document: `null`
  - Source step: `Opening Classification Sprint — Manager`
  - Task: Execute the full Opening Classification sprint: create ECO classifier module, wire into imports, backfill existing games, add opening filter UI
  - Created by: `Claude Code`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:33:40.686Z`
  - Reviewed by: `Codex`
  ...
  - Manual checklist:
    - [ ] Import a PGN via paste with no Opening/ECO headers — opening column shows classified name
    - [ ] Import Lichess username games — all games have opening names
    - [ ] Import Chess.com username games — all games have opening names
    - [ ] Reload app — existing games that previously had no opening now show classified name
    - [ ] Console shows 'Backfilled opening data for N games'
    - [ ] Games tab has Opening filter input — typing 'Sicilian' filters correctly
    - [ ] Typing 'B20' filters by ECO code
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-518`
  - Parent prompt ID: `CCP-562`
  - Batch prompt IDs: none
  - Source document: `null`
  - Source step: `Opening Classification Sprint — Step 4`
  - Task: Add IndexedDB indexes on eco/opening fields (version bump 6→7) and add an opening/ECO text filter to the Games tab UI
  - Created by: `Claude Code`
  - Created at: `2026-03-30T12:00:00.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:13:58.537Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  ...
  - Manual checklist:
    - [ ] Open Games tab — confirm Opening filter input appears in the filter bar
    - [ ] Type 'Sicilian' in the opening filter — confirm only Sicilian games show
    - [ ] Type 'B20' in the opening filter — confirm only ECO B20 games show
    - [ ] Filter is case-insensitive (try 'sicilian')
    - [ ] Open browser DevTools Application tab, check IDB — confirm 'eco' and 'opening' indexes exist on 'games' store
    - [ ] App loads without IDB errors after version upgrade
    - [ ] npm run build passes
```
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `null`
  - Source step: `Opening Classification Sprint — Step 3`
  - Task: Add backfillOpenings() to IDB module, wire classifyOpening into openings research import, trigger backfill at startup
  - Created by: `Claude Code`
  - Created at: `2026-03-30T12:00:00.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:13:57.546Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Reload the app with existing games that show '–' for opening — confirm they now show classified names after reload
    - [ ] Check browser console for 'Backfilled opening data for N games' message
    - [ ] Import a research game via openings import with no Opening/ECO headers — confirm it gets classified opening
    - [ ] npm run build passes
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `null`
  - Source step: `Opening Classification Sprint — Step 2`
  - Task: Wire classifyOpening() fallback into pgn.ts, lichess.ts, and chesscom.ts import adapters when PGN headers lack opening/eco data
  - Created by: `Claude Code`
  - Created at: `2026-03-30T12:00:00.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:13:56.558Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import a PGN via paste with no Opening/ECO headers — confirm game shows classified opening name
    - [ ] Import Lichess games — all games have opening names (from header or classifier)
    - [ ] Import Chess.com games — all games have opening names (from header or classifier)
    - [ ] npm run build passes
    - [ ] npx tsc --noEmit passes
```
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `null`
  - Source step: `Opening Classification Sprint — Step 1`
  - Task: Create src/openings/eco.ts with static ECO database from lichess-org/chess-openings and classifyOpening() function
  - Created by: `Claude Code`
  - Created at: `2026-03-30T12:00:00.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:13:55.581Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import a PGN with no Opening/ECO headers and confirm classifyOpening returns an opening name
    - [ ] classifyOpening('1. e4 e5 2. Nf3 Nc6 3. Bb5') returns { eco: 'C60', name contains 'Ruy Lopez' }
    - [ ] classifyOpening('1. d4 d5 2. c4') returns { eco: 'D06', name contains "Queen's Gambit" }
    - [ ] npm run build passes
    - [ ] npx tsc --noEmit passes
```
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:35:14.092Z`
  - Reviewed by: unknown
  ...
  - Sprint task ID: `SPR-012-T08`
```

## CCP-305 - Add Client Push Pull And Merge For Rated Puzzle Data
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:34:22.575Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:34:00.441Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:32:39.827Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-301 - Rated Ladder Cloud Ownership Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-301`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-302`, `CCP-303`, `CCP-304`, `CCP-305`, `CCP-306`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 8 — Cloud ownership, auth seam, and sync / manager prompt`
  - Task: execute the rated ladder cloud ownership prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:32:22.600Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 7 — Rated ladder UI and feedback surfaces / Task 4`
  - Task: add the smallest safe UI surfaces for current user puzzle rating and immediate round rating gain or loss so rated results are visible right away and sourced from real stored rating data
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:32:22.255Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 7 — Rated ladder UI and feedback surfaces / Task 3`
  - Task: add the smallest safe UI messaging when a previously correctly solved puzzle appears and is being treated as casual-only rather than as a rated-scoring round
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:32:21.926Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:32:21.585Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:24:49.906Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-295 - Rated Ladder UI Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-295`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-296`, `CCP-297`, `CCP-298`, `CCP-299`, `CCP-300`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 7 — Rated ladder UI and feedback surfaces / manager prompt`
  - Task: execute the rated ladder ui prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:24:49.569Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 6 — Rated completion and rating updates / Task 5`
  - Task: review the rated completion and rating-update changes with a findings-first mindset before the UI begins surfacing their results
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:24:33.732Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 6 — Rated completion and rating updates / Task 4`
  - Task: take the smallest safe step to write rating-before and rating-after snapshots and durable rating history on rated completion, including the assistance-triggered immediate-fail path
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:24:33.399Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:23:41.076Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:23:40.743Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:22:47.260Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-289 - Rated Ladder Completion And Rating Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-289`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-290`, `CCP-291`, `CCP-292`, `CCP-293`, `CCP-294`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 6 — Rated completion and rating updates / manager prompt`
  - Task: execute the rated ladder completion and rating prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:22:46.924Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:22:36.569Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:21:25.966Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:21:25.630Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:20:39.612Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:19:43.119Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-283 - Rated Ladder Eligibility And Selection Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-283`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-284`, `CCP-285`, `CCP-286`, `CCP-287`, `CCP-288`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 5 — Rated eligibility and selection / manager prompt`
  - Task: execute the rated ladder eligibility and selection prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:19:42.785Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:19:32.618Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:19:12.520Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:18:46.002Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:18:16.749Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:17:46.712Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-277 - Rated Ladder Session Policy Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-277`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-278`, `CCP-279`, `CCP-280`, `CCP-281`, `CCP-282`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 4 — Rated session policy and assistance handling / manager prompt`
  - Task: execute the rated ladder session policy prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:17:46.321Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:17:32.482Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:16:02.306Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:15:30.477Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:15:30.142Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:14:41.304Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-271 - Rated Ladder Local Persistence Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-271`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-272`, `CCP-273`, `CCP-274`, `CCP-275`, `CCP-276`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 3 — Local persistence and restore / manager prompt`
  - Task: execute the rated ladder local persistence prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:14:40.973Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 2 — Local rating domain foundations / Task 5`
  - Task: review the local rated ladder domain-type changes with a findings-first mindset before persistence or controller wiring begins
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:14:31.354Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:14:16.738Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:13:58.214Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:13:47.061Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:13:14.877Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-265 - Rated Ladder Local Domain Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-265`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-266`, `CCP-267`, `CCP-268`, `CCP-269`, `CCP-270`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 2 — Local rating domain foundations / manager prompt`
  - Task: execute the rated ladder local domain prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:13:14.541Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:13:03.830Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:12:28.357Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:12:24.636Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:12:23.687Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:11:32.280Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-259 - Rated Ladder Research And Parity Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-259`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-260`, `CCP-261`, `CCP-262`, `CCP-263`, `CCP-264`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Phase 1 — Research, parity re-check, and implementation map / manager prompt`
  - Task: execute the rated ladder research and parity prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T01:10:22.324Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-258 - Rated Puzzle Ladder Full Sprint Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-258`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-259`, `CCP-265`, `CCP-271`, `CCP-277`, `CCP-283`, `CCP-289`, `CCP-295`, `CCP-301`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_LADDER_AND_CLOUD_OWNERSHIP_SPRINT_2026-03-29.md`
  - Source step: `Full rated puzzle ladder and cloud ownership sprint batch manager`
  - Task: execute the full rated puzzle ladder and cloud ownership sprint by running the section manager prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T01:03:19.658Z`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:23:24.601Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:26:31.981Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T20:03:24.610Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:25:28.487Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:24:27.900Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:12:23.841Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:56:46.655Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:06:41.589Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:11:23.850Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:09:39.812Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:08:49.749Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:06:42.785Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:00:16.012Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:03:00.101Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:02:00.280Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:01:15.212Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:00:17.063Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:57:06.223Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:59:28.793Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:58:45.088Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:58:00.295Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:57:07.316Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:35:08.302Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:35:23.118Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:36:57.457Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:37:23.934Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:37:49.270Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:38:18.433Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:15:31.721Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:16:25.349Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:17:11.567Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:17:37.864Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:18:16.275Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:50:23.794Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:20:17.888Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:21:44.754Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:23:31.126Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:24:29.809Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:25:05.821Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:50:23.893Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:27:24.463Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:28:14.767Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:29:31.046Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:31:40.855Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:33:14.243Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:34:20.427Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:34:54.979Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:35:24.949Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:15:25.620Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:45.455Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:45.589Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:27:23.404Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T06:33:12.690Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:45.641Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T23:47:55.769Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:53:49.600Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T23:50:48.614Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T23:52:52.657Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:57:14.426Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:57:14.374Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:57:14.557Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T22:51:51.967Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T22:54:07.245Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-164-F1 - Fix Puzzle Phase 2/3 exactOptionalPropertyTypes Breakages
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T21:46:33.627Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint task ID: `SPR-011-T05`
```

## CCP-176-F3 - Fix Dashboard Index Sort After Queue Section
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T21:28:52.453Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-176-F2 - Diagnose Missing Started Status For Dashboard Prompts
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T21:10:38.043Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-176-F1 - Expose Prompt Metadata In Dashboard Detail View
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T21:13:40.419Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-176 - Generate Prompt Tracking HTML Dashboard
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:33:14.861Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T22:26:30.440Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T22:20:50.863Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T22:18:26.801Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-27T21:59:34.823Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:35.776Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:37.051Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:20.248Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:18.997Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T21:51:00.681Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:58:02.642Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:58:03.818Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:58:06.190Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:58:09.776Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:58:08.549Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:04:26.984Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:04:42.313Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:04:43.556Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:04:44.800Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:04:46.055Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:00.079Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:01.309Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:02.543Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:03.791Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:58:07.360Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:58:05.014Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:58:01.457Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:58:00.239Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:15.282Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:16.520Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T23:05:17.740Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:51:00.026Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:08:36.900Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:09:43.341Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:51:10.389Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-28T07:11:23.731Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:45.538Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T20:12:28.775Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T20:13:17.389Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:51:13.893Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T20:16:10.430Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T20:22:04.853Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:51:17.338Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T21:11:23.126Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T20:57:42.339Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T22:11:43.516Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T22:12:49.351Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T22:18:57.451Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T22:22:21.949Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:44:41.517Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T23:31:10.366Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T22:39:43.711Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T22:41:16.290Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T22:08:35.936Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:45.487Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:57:14.506Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:57:14.402Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:57:14.454Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-29T23:56:13.128Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T00:48:12.118Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T00:52:05.343Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T00:53:58.189Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T00:56:17.616Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:56:14.149Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:56:20.591Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
## CCP-307 - Rated Puzzle Stream Full Sprint Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-307`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-308`, `CCP-312`, `CCP-315`, `CCP-319`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_STREAM_SPRINT_2026-03-29.md`
  - Source step: `Full rated puzzle stream sprint batch manager`
  - Task: execute the full rated puzzle stream sprint by running the phase manager prompts in order
  - Created by: `Claude`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:55:11.893Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Task ID: `CCP-308`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-309`, `CCP-310`, `CCP-311`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_STREAM_SPRINT_2026-03-29.md`
  - Source step: `Phase 1 — Research and implementation map / manager prompt`
  - Task: execute the research and implementation map prompts in order
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T02:13:45.482Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task: audit PuzzleSession and PuzzleSelector in Lichess source to understand how rated puzzle streams are selected and served
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T02:13:48.796Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task: audit selectNextRatedPuzzle() and the shard loader to precisely characterize the IDB-only gap and what a shard fallback needs
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T02:15:45.602Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task: append a rated puzzle stream implementation map section to docs/RATED_PUZZLE_LADDER_IMPL_MAP.md based on research findings
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T02:15:45.976Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-312`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-313`, `CCP-314`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_STREAM_SPRINT_2026-03-29.md`
  - Source step: `Phase 2 — Shard loader integration / manager prompt`
  - Task: execute the shard loader integration prompts in order
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:45.692Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Task: add findRatedPuzzleFromShards(rating, windowHalf, excludeIds) to puzzleDb.ts to search shard data for a puzzle in a rating window and import it into IDB
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:50:23.841Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Task: wire findRatedPuzzleFromShards as a fallback in selectNextRatedPuzzle() so it falls through to shard data when IDB returns nothing
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:50:40.104Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Task ID: `CCP-315`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-316`, `CCP-317`, `CCP-318`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_STREAM_SPRINT_2026-03-29.md`
  - Source step: `Phase 3 — Controller + UI wiring / manager prompt`
  - Task: execute the controller and UI wiring prompts in order
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T02:17:30.528Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task: add startRatedSession(), stopRatedStream(), and supporting stream state to ctrl.ts
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T02:17:30.896Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task: add renderRatedStreamEntry() to view.ts and wire it into the puzzle left-panel sidebar
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T02:18:10.870Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task: wire auto-advance in recordAttempt() so completing a rated stream round automatically loads the next puzzle
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T02:19:44.142Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-319`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-320`, `CCP-321`
  - Source document: `docs/mini-sprints/RATED_PUZZLE_STREAM_SPRINT_2026-03-29.md`
  - Source step: `Phase 4 — Styles and integration review / manager prompt`
  - Task: execute the styles and integration review prompts in order
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T02:20:12.220Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task: append .puzzle__rated-stream-entry SCSS rules to main.scss for the rated stream sidebar card
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T02:20:12.606Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task: integration review: verify all rated stream sprint deliverables are present and the build is clean
  - Created by: `Claude`
  - Created at: `2026-03-29T00:00:00Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:58.385Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Task: redesign the openings session White / Black / Flip controls so they feel visually balanced, intentional, and cohesive without changing their underlying behavior
  - Created by: `Codex`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T03:56:07.658Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task: execute the full openings opponent tool suite sprint by running the section manager prompts in order
  - Created by: `Codex`
  ...
  - Manual checklist:
    ...
    - [ ] Openings page: all five tool-rail tabs work (Opening Tree, Repertoire, Prep Report, Style, Practice)
    - [ ] Style dashboard renders with player card, axes, signals, form, behavioral sections
    - [ ] Practice tool: color picker, session start, opponent auto-response, source banner, stop
    - [ ] No console errors across all tool navigations
```
...
- [x] Reviewed
  ...
  - Task ID: `CCP-324`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-325`, `CCP-326`, `CCP-327`, `CCP-328`, `CCP-329`, `CCP-330`
  - Source document: `docs/mini-sprints/OPENINGS_OPPONENT_TOOL_SUITE_SPRINT_2026-03-29.md`
  - Source step: `Phase 1 — Grounding, repo audit, and implementation map / manager prompt`
  - Task: execute the grounding and implementation-map prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
...
- [x] Reviewed
  ...
  - Task ID: `CCP-331`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-332`, `CCP-333`, `CCP-334`, `CCP-335`, `CCP-336`, `CCP-337`, `CCP-338`
  - Source document: `docs/mini-sprints/OPENINGS_OPPONENT_TOOL_SUITE_SPRINT_2026-03-29.md`
  - Source step: `Phase 2 — Session tool shell and mode architecture / manager prompt`
  - Task: execute the openings session tool shell and mode architecture prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
...
- [x] Reviewed
  ...
  - Task ID: `CCP-339`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-340`, `CCP-341`, `CCP-342`, `CCP-343`, `CCP-344`, `CCP-345`, `CCP-346`
  - Source document: `docs/mini-sprints/OPENINGS_OPPONENT_TOOL_SUITE_SPRINT_2026-03-29.md`
  - Source step: `Phase 3 — Shared opponent analytics foundation / manager prompt`
  - Task: execute the opponent analytics foundation prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
...
- [x] Reviewed
  ...
  - Task ID: `CCP-347`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-348`, `CCP-349`, `CCP-350`, `CCP-351`, `CCP-352`, `CCP-353`, `CCP-354`
  - Source document: `docs/mini-sprints/OPENINGS_OPPONENT_TOOL_SUITE_SPRINT_2026-03-29.md`
  - Source step: `Phase 4 — Repertoire tool full-page upgrade / manager prompt`
  - Task: execute the Repertoire tool full-page upgrade prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
...
- [x] Reviewed
  ...
  - Task: execute the Prep Report dashboard prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
...
- [x] Reviewed
  ...
  - Task: execute the Style dashboard prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
  ...
  - Sprint task ID: `SPR-006-T06`
  - Completed at: `2026-03-31T06:15:06.792Z`
  - Manual checklist:
    - [ ] Style tool renders all sections: player card, axes, signals, first-move breakdown, form, behavioral
    - [ ] Style archetype label displays correctly
    - [ ] Signals show confidence levels
    - [ ] No console errors on Style tab
```
...
- [x] Reviewed
  ...
  - Task: execute the Practice Against Them prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
  ...
  - Sprint task ID: `SPR-006-T07`
  - Completed at: `2026-03-31T06:15:16.855Z`
  - Manual checklist:
    - [ ] Practice tool: color picker renders before session start
    - [ ] Practice session starts on color click, board restricts movement to user color
    - [ ] Opponent auto-responds from repertoire after user moves
    - [ ] Source banner shows repertoire/engine/exhausted state
    - [ ] Stop button ends session and returns to Opening Tree
    - [ ] No console errors during practice session
```
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T20:38:45.559Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Sprint phase ID: `SPR-006-P5`
  - Sprint task ID: `SPR-006-T05`
  - Completed at: `2026-03-31T01:52:57.977Z`
  - Completion errors: Dead recency toggle: recencyMode() state is rendered in UI but never passed to any analytics function — toggling Recent/All time has no visible effect
  - Manual checklist:
    - [ ] Open collection, go to Prep Report, verify full dashboard visible (header, W/D/L bar, Likely Lines, Target Lines)
    - [ ] Click 'All time' toggle — note data does not change (known dead toggle)
    - [ ] Click any Likely Line row — confirm navigation to Opening Tree at the correct branch
    - [ ] Open collection with <20 games — confirm sparse-data warning banner appears
    - [ ] Click any Target Line — confirm navigation to Opening Tree at correct branch
```
...
- [x] Reviewed
  ...
  - Task: add the canonical style-profile synthesis model and owner seam so the `Style` tool can be built on explicit data structures instead of view-local labels and one-off score cards
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:06.225Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P6`
  - Sprint task ID: `SPR-006-T06`
  - Completed at: `2026-03-31T01:55:33.988Z`
  - Manual checklist:
    - [ ] Open collection → navigate to Style tool → no console errors
    - [ ] Verify existing Opening Tree and Prep Report tools still work correctly
    - [ ] Check dev console: no import errors for computeStyleViewModel or StyleViewModel
```
...
- [x] Reviewed
  ...
  - Task: derive the core style axes Patzer can honestly support now, such as repertoire breadth, predictability, risk appetite, and tendency toward narrow or broad comfort zones, from the analytics already owned by the openings subsystem
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:10.715Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P6`
  - Sprint task ID: `SPR-006-T06`
  - Completed at: `2026-03-31T01:56:58.450Z`
  - Manual checklist:
    - [ ] Open collection → navigate to Style tool → no console errors
    - [ ] Verify build passes (npm run build + npx tsc --noEmit)
    - [ ] Existing Prep Report and Opening Tree tools unaffected
```
...
- [x] Reviewed
  ...
  - Task: derive the recent-form, stability, and volatility signals that belong inside the `Style` tool so the dashboard can show how the opponent is behaving lately without splitting that information into a separate top-level tool
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:11.715Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P6`
  - Sprint task ID: `SPR-006-T06`
  - Completed at: `2026-03-31T01:57:34.056Z`
  - Manual checklist:
    - [ ] Verify build passes: npm run build + npx tsc --noEmit
    - [ ] Open collection → navigate to Style tool → no console errors
    - [ ] Check that FormData is accessible via getStyleViewModel().form in the browser if needed
```
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:16.057Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P6`
  - Sprint task ID: `SPR-006-T06`
  - Completed at: `2026-03-31T01:59:48.149Z`
  - Manual checklist:
    - [ ] Open collection → click Style in tool rail → full Style dashboard appears (header, signals, first-move breakdown, form section)
    - [ ] Verify 'Observed facts' section shows first-move preferences
    - [ ] Verify 'Inferences' section shows predictability and trend signals
    - [ ] Verify other tools (Opening Tree, Prep Report) still work after switching away from Style
    - [ ] No console errors when navigating to/from Style tool
```
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:17.067Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P6`
  - Sprint task ID: `SPR-006-T06`
  - Completed at: `2026-03-31T02:01:11.600Z`
  - Manual checklist:
    - [ ] Open collection → Style tool → player card appears at top with archetype label (e.g., 'Book Player', 'Gambit Player')
    - [ ] Verify style axis bars appear below the player card (Repertoire breadth, Opening variety)
    - [ ] Archetype qualifier text appears under the archetype label
    - [ ] No console errors when navigating to Style tool
```
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:18.064Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P6`
  - Sprint task ID: `SPR-006-T06`
  - Completed at: `2026-03-31T05:25:02.443Z`
  - Manual checklist:
    - [ ] Open collection → Style tool → 'Behavioral tendencies' section appears below Form section
    - [ ] Verify opening commitment label shows (High/Moderate/Low) with detail text
    - [ ] If recent topEco differs from baseline topEco: 'Recent opening shift' row appears
    - [ ] If topEco is stable: 'Stable opening choice' row appears
    - [ ] Caveat banner 'These are observed patterns only' is visible in behavioral section
    - [ ] No console errors when navigating to Style tool
```
...
- [x] Reviewed
  ...
  - Sprint phase ID: `SPR-006-P6`
  - Sprint task ID: `SPR-006-T06`
  - Completed at: `2026-03-31T05:26:11.090Z`
  - Completion errors: Duplication: top3EcoPct appears as both a comfort zone signal in Signals section and an opening commitment row in Behavioral section — same metric, nearly identical wording, shown to user twice
  - Manual checklist:
    - [ ] Open collection (20+ games) → Style tool → verify all sections render (header, player card, axes, signals, first-moves, form, behavioral)
    - [ ] Check 'Inferences' group — note 'comfort zone' signal present
    - [ ] Check 'Behavioral tendencies' — note 'opening commitment' row also present (duplication of top3EcoPct)
    - [ ] Confidence badge in header matches game count threshold
    - [ ] Open collection < 5 games → player card should not appear
    - [ ] Switch collections → Style content refreshes correctly
```
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:27.700Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  ...
  - Sprint phase ID: `SPR-006-P7`
  - Sprint task ID: `SPR-006-T07`
  - Completed at: `2026-03-31T05:44:09.979Z`
  - Manual checklist:
    - [ ] No code was changed in this audit — verify no unexpected file modifications via git status
    - [ ] Confirm src/openings/practice.ts does not yet exist (placeholder only in type definition)
    - [ ] Verify OpeningsTool type in types.ts includes 'practice' as a valid string
```
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:28.910Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P7`
  - Sprint task ID: `SPR-006-T07`
  - Completed at: `2026-03-31T05:46:06.297Z`
  - Manual checklist:
    - [ ] Navigate to Openings → open any collection → verify tool switches correctly (Opening Tree / Prep Report / Style work normally)
    - [ ] No console errors on any openings tool navigation
    - [ ] Build passes: npm run build + npx tsc --noEmit
```
...
- [x] Reviewed
  ...
  - Task: add the move-selection service that lets `Practice Against Them` choose opponent moves from imported repertoire data while the current branch is still well-supported by the researched game history
  - Created by: `Codex`
  - Created at: `2026-03-30T04:49:15.576Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:34.012Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P7`
  - Sprint task ID: `SPR-006-T07`
  - Completed at: `2026-03-31T05:47:32.080Z`
  - Manual checklist:
    - [ ] Build passes: npm run build + npx tsc --noEmit
    - [ ] Existing Prep Report, Style, Opening Tree tools work normally after this change
    - [ ] No console errors on any openings tool navigation
```
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:35.011Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P7`
  - Sprint task ID: `SPR-006-T07`
  - Completed at: `2026-03-31T05:48:48.407Z`
  - Manual checklist:
    - [ ] Build passes: npm run build + npx tsc --noEmit
    - [ ] Existing Prep Report, Style, Opening Tree tools work normally
    - [ ] No console errors on any openings tool navigation
```
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:36.008Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P7`
  - Sprint task ID: `SPR-006-T07`
  - Completed at: `2026-03-31T05:51:17.818Z`
  - Manual checklist:
    - [ ] Open collection → click Practice in tool rail → color picker setup panel appears
    - [ ] Click 'White' or 'Black' → session starts, active panel appears with source banner
    - [ ] Source banner shows green 'Playing from imported repertoire' if tree has data at current position
    - [ ] Stop Practice button appears in active panel; clicking it returns to Opening Tree
    - [ ] Other tools (Opening Tree, Style, Prep Report) still work after switching away from Practice
    - [ ] No console errors when navigating to/from Practice tool
```
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T19:35:39.691Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint phase ID: `SPR-006-P7`
  - Sprint task ID: `SPR-006-T07`
  - Completed at: `2026-03-31T05:54:26.646Z`
  - Manual checklist:
    - [ ] Open collection → Practice tool → select White → session starts
    - [ ] Play a move that's in the opponent's tree: opponent auto-responds after ~400ms
    - [ ] Source banner shows green 'Playing from imported repertoire' while tree data exists
    - [ ] Navigate to a deep branch with no children: banner changes to blue 'Engine has taken over'
    - [ ] Opponent's pieces cannot be moved manually during practice (movable.color restricted)
    - [ ] Stop Practice → returns to Opening Tree, browse mode restored (both colors movable)
    - [ ] No console errors throughout practice flow
```
...
- [x] Reviewed
  ...
  - Sprint phase ID: `SPR-006-P7`
  - Sprint task ID: `SPR-006-T07`
  - Completed at: `2026-03-31T05:56:02.010Z`
  - Completion errors: High: movable.color stays stale during practice start/stop due to syncOpeningsBoard FEN guard — opponent pieces may remain draggable when practice starts at same FEN; Medium: planOpponentTurn called in render for banner display calls Math.random() unnecessarily
  - Manual checklist:
    - [ ] Start practice at starting position → verify opponent pieces NOT draggable immediately
    - [ ] Play tree move as White → opponent auto-responds after 400ms
    - [ ] Navigate to deep branch with no children → banner shows engine phase
    - [ ] Stop Practice → verify browse mode restored (both sides movable)
    - [ ] Rapidly play 2+ moves before opponent responds → verify only one opponent response fires
    - [ ] No console errors throughout practice session
```

## CCP-379 - Enable Clock Data On Lichess Import
...
- [x] Reviewed
  ...
  - Task: add clocks=true to the Lichess import export request so newly imported Lichess games retain per-move clock data
  - Created by: `Codex`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:31:48.041Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint task ID: `SPR-004-T01`
```

## CCP-380 - Add GameSummary Type And Persistence
...
- [x] Reviewed
  ...
  - Task: define the GameSummary model and add game-summary persistence to the main IDB database
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:36:56.369Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint ID: `SPR-004`
  - Sprint phase ID: `SPR-004-P1`
  - Sprint task ID: `SPR-004-T02`
```

## CCP-381 - Extract GameSummary From Analyzed Games
...
- [x] Reviewed
  ...
  - Task: implement extractGameSummary and persist game summaries automatically when analysis completes
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:38:15.920Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint ID: `SPR-004`
  - Sprint phase ID: `SPR-004-P1`
  - Sprint task ID: `SPR-004-T03`
```

## CCP-382 - Backfill Missing GameSummaries
...
- [x] Reviewed
  ...
  - Task: backfill GameSummary records for already analyzed games that do not yet have summaries
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:41:25.875Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint ID: `SPR-004`
  - Sprint phase ID: `SPR-004-P1`
  - Sprint task ID: `SPR-004-T04`
```

## CCP-383 - Add Stats Controller And Route Wiring
...
- [x] Reviewed
  ...
  - Task: create the stats controller and replace the /stats placeholder route with the new controller-driven surface
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:43:49.912Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint ID: `SPR-004`
  - Sprint phase ID: `SPR-004-P1`
  - Sprint task ID: `SPR-004-T05`
```

## CCP-384 - Build Weakness Aggregation Engine
...
- [x] Reviewed
  ...
  - Task: build the weakness aggregation engine that ranks the user's top diagnosed weaknesses from GameSummary records
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:46:04.180Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint ID: `SPR-004`
  - Sprint phase ID: `SPR-004-P1`
  - Sprint task ID: `SPR-004-T06`
```

## CCP-385 - Add Stats Weakness Panel
...
- [x] Reviewed
  ...
  - Task: render the primary weakness panel on the stats page using diagnosed weakness output
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:01:43.401Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-386 - Add Accuracy And Blunder Trend Charts
...
- [x] Reviewed
  ...
  - Task: add rolling accuracy and blunder-rate trend charts to the stats page with time-control separation and minimum thresholds
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:03:17.370Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-387 - Add Opening Performance Table
...
- [x] Reviewed
  ...
  - Task: add the opening performance table to the stats page, sorted worst-first and gated by per-opening sample size
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:04:15.018Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-388 - Add Tactical Profile Section
...
- [x] Reviewed
  ...
  - Task: add the tactical profile section showing missed moments per game, totals, and type breakdown
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:04:56.247Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-389 - Add Post Game Summary Panel
...
- [x] Reviewed
  ...
  - Task: add a collapsible post-game summary panel below the existing analysis UI after analysis completion
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:05:54.551Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-390 - Persist Retro Session Results
...
- [x] Reviewed
  ...
  - Task: persist retrospection session results into a retro-results IDB store for completed and meaningful partial sessions
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:32:29.522Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
  ...
  - Sprint ID: `SPR-004`
  - Sprint phase ID: `SPR-004-P1`
  - Sprint task ID: `SPR-004-T13`
```

## CCP-391 - Add Weakness Training Actions
...
- [x] Reviewed
  ...
  - Task: enhance diagnosed weaknesses with working Train this actions that route into puzzles, retrospection, openings, or review flows
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:02:29.387Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-392 - Add Time Management Profile Section
...
- [x] Reviewed
  ...
  - Task: add the clock and time-management profile section to the stats page when enough games include clock data
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:07:43.927Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-393 - Add Conversion And Resourcefulness Metrics
...
- [x] Reviewed
  ...
  - Task: add conversion and resourcefulness metrics to the stats page with sample-size gating and optional review links
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:08:21.283Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
## CCP-394 - Improvement Intelligence Quick Wins Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-394`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-379`, `CCP-390`
  - Source document: `docs/mini-sprints/IMPROVEMENT_INTELLIGENCE_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Quick wins batch manager`
  - Task: execute the standalone quick wins for clock import and retro-session persistence in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:31:47.055Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-395`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-380`, `CCP-381`, `CCP-382`, `CCP-383`
  - Source document: `docs/mini-sprints/IMPROVEMENT_INTELLIGENCE_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Foundation spine batch manager`
  - Task: execute the foundation spine for GameSummary persistence, extraction, backfill, and stats routing in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:36:55.337Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-396`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-384`, `CCP-385`, `CCP-391`
  - Source document: `docs/mini-sprints/IMPROVEMENT_INTELLIGENCE_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Weakness engine and recommendations batch manager`
  - Task: execute the weakness engine, weakness panel, and training recommendation prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:46:03.199Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-397`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-386`, `CCP-387`, `CCP-388`, `CCP-389`, `CCP-392`, `CCP-393`
  - Source document: `docs/mini-sprints/IMPROVEMENT_INTELLIGENCE_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Stats surfaces and analysis extension batch manager`
  - Task: execute the chart, opening table, tactical profile, analysis summary, clock profile, and conversion metrics prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:03:16.390Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-398`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-394`, `CCP-395`, `CCP-396`, `CCP-397`
  - Source document: `docs/mini-sprints/IMPROVEMENT_INTELLIGENCE_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Full improvement intelligence platform sprint batch manager`
  - Task: execute the full improvement intelligence platform sprint by running the section managers in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:20:21Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T06:31:15.201Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Source step: `Task 0.1 — Route rename in router`
  - Task: rename the router entry from openings to opponents while preserving backward compatibility for old #/openings links
  - Created by: `Codex`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:03:55.430Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 0.1 — Header navigation rename`
  - Task: rename the header navigation label, href, and active-section handling from Openings to Opponents
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:04:20.513Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 0.1 — Main route checks rename`
  - Task: rename the main route case and route-name checks from openings to opponents so the app shell loads the page under its new canonical route
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:04:35.059Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 0.2 — View titles rename`
  - Task: rename the primary user-facing titles in the openings view from Opening Preparation to Opponent Research
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:05:02.228Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 0.2 — Empty state and menu copy rename`
  - Task: rename the remaining user-facing Opponents copy in openings/view.ts, including empty-state and menu-title strings
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:05:03.221Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 1.1 — Rating sparkline data extraction`
  - Task: extract date-sorted rating series for the target player from ResearchGame data for later sparkline rendering
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:05:47.859Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 1.1 — Sparkline SVG rendering`
  - Task: add the inline SVG sparkline renderer for opponent collection cards using the extracted rating series
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:07:40.627Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 1.1 — Sparkline peak/current/trend indicators`
  - Task: add peak marker, current label, and trend-arrow treatment to the collection-card rating sparkline
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:50:47.311Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 1.1 — Sparkline card integration`
  - Task: mount the completed sparkline component into opponent collection cards with graceful hiding for sparse data
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:07:42.653Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 2.1 — Termination profile extraction`
  - Task: parse and normalize PGN Termination headers from research games into a pure termination-profile function
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:50:50.634Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 2.1 — Game length profile extraction`
  - Task: add a pure game-length profile extractor for opponent research games
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:10:06.626Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 2.2 — Termination profile display`
  - Task: render the termination-profile cards in the Prep Report with sample sizes and blitz-relevant timeout emphasis
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:10:06.962Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 2.2 — Game length display`
  - Task: render the game-length section in the Prep Report, including average win length vs loss length
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:10:07.301Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 3.1 — Deviation types and scan contract`
  - Task: create the DeviationPoint model and scan contract for opponent deviation detection
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:08:36.192Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 3.1 — Deviation tree walker`
  - Task: implement the bounded tree walk that finds deviation-scan candidate nodes with game-count thresholds
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:08:36.550Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 3.1 — Explorer comparison adapter`
  - Task: compare candidate nodes against explorer top moves through a small adapter layer
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:08:36.907Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 3.1 — Rate limit and cache`
  - Task: add rate limiting, query caps, and per-collection cache behavior to deviation scans
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:08:37.262Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 3.1 — Progressive async scan orchestration`
  - Task: make deviation scans asynchronous with progressive result delivery and redraw support
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:08:37.618Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 3.2 — Deviation markers in tree view`
  - Task: add deviation markers and theory-move hints to rendered opponent move rows
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:50:56.475Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 3.2 — Deviation summary panel`
  - Task: add the top deviations summary panel beneath played lines
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:08:38.345Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 3.3 — Deviation controller state`
  - Task: add controller state for deviation results, loading, and progress
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:08:38.689Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 3.3 — Deviation scan UX`
  - Task: add the manual scan button and progress UI for deviation detection
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:08:39.067Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:10:07.637Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 4.1 — Recommendation engine`
  - Task: compute actionable opening recommendations from existing WeaknessModule output
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:10:07.982Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 4.1 — Recommendation action wiring`
  - Task: attach stable navigation targets and action metadata to opening recommendations
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:10:08.320Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 4.2 — Recommendation cards in Prep Report`
  - Task: render the Recommended Preparation section in the Prep Report with clickable recommendation cards
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:10:08.658Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 5.1 — Trap pattern model`
  - Task: define the TrapPattern model and the significance thresholds for repeated-loss trap detection
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:12:11.058Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 5.1 — Trap detection DFS`
  - Task: implement the DFS trap detector for repeated opponent losses after the same move
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:12:11.411Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 5.1 — Trap ranking heuristics`
  - Task: sort and refine trap patterns using loss rate, loss count, and quick-loss heuristics
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:12:11.762Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 5.2 — Vulnerable positions view`
  - Task: render the Vulnerable Positions section in the Prep Report from detected trap patterns
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:12:12.120Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:12:12.471Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 6.1 — Percentage sample size labels`
  - Task: add explicit (n=X) labels to all percentage stats across opponent research surfaces
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:08:47.498Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 6.1 — Collection warning badges`
  - Task: add collection-card warning badges for small-sample opponent collections
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:08:48.521Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 6.1 — Prep report warning banner`
  - Task: add a persistent small-sample warning banner to the Prep Report header when data is sparse
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:08:49.530Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 6.1 — De-emphasis of unreliable stats`
  - Task: visually de-emphasize low-frequency unreliable stats across opponent research views
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:08:50.529Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 7.1 — Recency mode state`
  - Task: add recency-mode state and controller plumbing for recent-vs-all-time prep behavior
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:12.812Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 7.1 — Recency-weighted default`
  - Task: make the Prep Report use recency-weighted likely lines by default
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:13.173Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 7.1 — Recency toggle UI`
  - Task: add the Recent first / All time toggle to the Prep Report header
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:13.527Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 7.1 — Auto-fallback logic`
  - Task: auto-fallback to all-time mode when recent sample size is too sparse
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:13.873Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 7.1 — Auto-fallback notice`
  - Task: show a clear notice when the Prep Report auto-falls back from recent to all-time mode
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:14.236Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 8.1 — Saved variation type`
  - Task: add the SavedVariation type to the openings data model
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:14.587Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 8.1 — Training variations IDB store`
  - Task: bump the openings DB and add the training-variations store
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:14.934Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 8.1 — Saved variation DB helpers`
  - Task: add saveVariation, loadVariations, and deleteVariation helpers for saved opening variations
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:15.298Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 8.2 — Repertoire save button`
  - Task: add Save to training support to the Repertoire move list when the current line is long enough
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:15.653Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 8.2 — Likely lines save button`
  - Task: add Save to training controls to Prep Report Likely Lines rows
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:16.004Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 8.2 — Target lines save button`
  - Task: add Save to training controls to Prep Report Target Lines rows
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:16.365Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 8.2 — Save confirmation UX`
  - Task: add brief Saved confirmation feedback for save-to-training actions
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:18:16.723Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 9.1 — Low-depth engine analysis feasibility research`
  - Task: produce the written feasibility study for low-depth engine analysis of opponent collections
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T17:01:11.571Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Task 9.2 — Clock data extraction feasibility research`
  - Task: produce the written feasibility study for opponent-research clock data extraction and analytics
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T17:01:12.623Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Sprint integration review`
  - Task: review the full opponent research platform sprint for correctness, honesty, UI coherence, and regression risk after implementation
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:55:11.930Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
- [x] Reviewed
  ...
  - Task ID: `CCP-449`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-399`, `CCP-400`, `CCP-401`, `CCP-402`, `CCP-403`
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Rename and shell batch manager`
  - Task: execute the rename and shell-alignment prompts for the Opponents platform in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T08:03:47.960Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-450`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-404`, `CCP-405`, `CCP-406`, `CCP-407`, `CCP-430`, `CCP-431`, `CCP-432`, `CCP-433`
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Sparkline and sample-size batch manager`
  - Task: execute the sparkline and sample-size honesty prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:58.414Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Task ID: `CCP-451`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-408`, `CCP-409`, `CCP-410`, `CCP-411`, `CCP-421`, `CCP-422`, `CCP-423`, `CCP-424`
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Termination and recommendations batch manager`
  - Task: execute the termination, game-length, and recommendation prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:58.436Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Task ID: `CCP-452`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-412`, `CCP-413`, `CCP-414`, `CCP-415`, `CCP-416`, `CCP-417`, `CCP-418`, `CCP-419`, `CCP-420`
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Deviation scan batch manager`
  - Task: execute the deviation detection and deviation UI prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:58.487Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Task ID: `CCP-453`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-425`, `CCP-426`, `CCP-427`, `CCP-428`, `CCP-429`, `CCP-434`, `CCP-435`, `CCP-436`, `CCP-437`, `CCP-438`
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Traps and recency batch manager`
  - Task: execute the trap-detection and recency-mode prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:11:38.178Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-454`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-439`, `CCP-440`, `CCP-441`, `CCP-442`, `CCP-443`, `CCP-444`, `CCP-445`
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Training variation batch manager`
  - Task: execute the saved-variation and save-to-training prompts in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T14:13:52.845Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-455`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-446`, `CCP-447`
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Feasibility research batch manager`
  - Task: execute the non-code research prompts for opponent collection analysis and clock extraction
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-03-30T17:01:10.505Z`
  - Reviewed by: unknown
  - Review method: unknown
  - Review scope: none
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-456`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-449`, `CCP-450`, `CCP-451`, `CCP-452`, `CCP-453`, `CCP-454`
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Implementation managers batch manager`
  - Task: execute the implementation section managers for the full Opponent Research Platform sprint in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:55:12.047Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Task ID: `CCP-457`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-456`, `CCP-455`, `CCP-448`
  - Source document: `docs/mini-sprints/OPPONENT_RESEARCH_PLATFORM_SPRINT_2026-03-29.md`
  - Source step: `Full opponent research platform sprint batch manager`
  - Task: execute the full Opponent Research Platform sprint by running implementation managers, research managers, and the final integration review in order
  - Created by: `Codex`
  - Created at: `2026-03-30T06:45:54Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:55:11.984Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
...
- [x] Reviewed
  ...
  - Source step: `Typecheck failures — openings/view.ts`
  - Task: fix all exactOptionalPropertyTypes violations in src/openings/view.ts so that npm run build passes with zero type errors in that file
  - Created by: `Claude`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:13:50.591Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
...
## CCP-459 - Fix exactOptionalPropertyTypes Violations In openings/import.ts
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/SPRINT_VS_IMPLEMENTATION_AUDIT_2026-03-30.md`
  - Source step: `Typecheck failures — openings/import.ts`
  - Task: fix all exactOptionalPropertyTypes violations in src/openings/import.ts so that npm run build passes with zero type errors in that file
  - Created by: `Claude`
  - Created at: `2026-03-30T17:21:33Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:13:51.585Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
...
## CCP-460 - Fix exactOptionalPropertyTypes Violations In openings/analytics.ts
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/SPRINT_VS_IMPLEMENTATION_AUDIT_2026-03-30.md`
  - Source step: `Typecheck failures — openings/analytics.ts`
  - Task: fix all exactOptionalPropertyTypes violations in src/openings/analytics.ts so that npm run build passes with zero type errors in that file
  - Created by: `Claude`
  - Created at: `2026-03-30T17:21:33Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:13:52.574Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open Opponents page, click a collection, verify termination profile renders
    - [ ] Check dev console for errors on the Opponents page
    - [ ] Verify analytics.ts has no typecheck warnings in IDE
```

## CCP-461 - Fix exactOptionalPropertyTypes Violations In puzzles/ctrl.ts
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:13:53.605Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
...
## CCP-462 - Fix Typecheck Failures In main.ts From Analysis Controls Migration
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/SPRINT_VS_IMPLEMENTATION_AUDIT_2026-03-30.md`
  - Source step: `Typecheck failures — main.ts analysis controls`
  - Task: fix typecheck failures in src/main.ts related to the analysis controls migration and explorer control-bar integration so that npm run build passes with zero type errors in main.ts
  - Created by: `Claude`
  - Created at: `2026-03-30T17:21:33Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:34:39.732Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
...
## CCP-463 - Wire Rated Puzzle Cloud Sync Into Runtime
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/SPRINT_VS_IMPLEMENTATION_AUDIT_2026-03-30.md`
  - Source step: `Dead code — rated puzzle cloud sync`
  - Task: wire the existing rated puzzle cloud sync functions into the puzzle runtime entry and auth flow so they are actually called — pull/merge rating history and rated attempts on login, push on rated session completion
  - Created by: `Claude`
  - Created at: `2026-03-30T17:21:33Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:34:40.699Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  - Review scope: campaign re-close of suspicious reviewed state
  - Skip reason: none
...
## CCP-464 - Remove Retro Lifecycle Hook Dead Code
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:13:54.602Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
...
## CCP-465 - Wire Book-Aware Cancellation Into Retro Flow
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:34:41.666Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  - Review scope: campaign re-close of suspicious reviewed state
  - Skip reason: none
...
## CCP-466 - Fix Sync Pull To Write Puzzle Attempts To IndexedDB
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:34:42.662Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  - Review scope: campaign re-close of suspicious reviewed state
  - Skip reason: none
...
## CCP-467 - Remove Legacy analyse__actions Render Path From main.ts
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:34:43.622Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  - Review scope: campaign re-close of suspicious reviewed state
  - Skip reason: none
...
## CCP-468 - Fix Deviation Markers To Render In Move Rows
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:34:44.600Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  - Review scope: campaign re-close of suspicious reviewed state
  - Skip reason: none
...
## CCP-469 - Fix Save-Puzzle Inconsistent Definition Creation
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:34:45.569Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  - Review scope: campaign re-close of suspicious reviewed state
  - Skip reason: none
...
## CCP-470 - Fix Bulk-Save To Preserve First-Attempt Outcome Info
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/SPRINT_VS_IMPLEMENTATION_AUDIT_2026-03-30.md`
  - Source step: `Bug — bulk-save missing first-attempt data`
...
## CCP-471 - Move findRatedPuzzleFromShards To puzzleDb.ts
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/SPRINT_VS_IMPLEMENTATION_AUDIT_2026-03-30.md`
  - Source step: `Misplaced code — rated puzzle shard lookup`
  - Task: move the findRatedPuzzleFromShards function from puzzles/ctrl.ts to puzzles/puzzleDb.ts where it belongs as a persistence-layer concern, update all callers
  - Created by: `Claude`
  - Created at: `2026-03-30T17:21:33Z`
...
## CCP-472 - Migrate Server DB From MySQL To SQLite
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:34:50.433Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  - Review scope: campaign re-close of suspicious reviewed state
  - Skip reason: none
...
## CCP-473 - Sprint Audit Fix-All Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-473`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-458`, `CCP-459`, `CCP-460`, `CCP-461`, `CCP-462`, `CCP-463`, `CCP-464`, `CCP-465`, `CCP-466`, `CCP-467`, `CCP-468`, `CCP-469`, `CCP-470`, `CCP-471`, `CCP-472`
  - Source document: `docs/audits/SPRINT_VS_IMPLEMENTATION_AUDIT_2026-03-30.md`
  - Source step: `Recommended Next Actions — fix all audit-identified issues`
  - Task: execute all 15 audit-identified fix prompts (CCP-458 through CCP-472) in order: typecheck fixes first, then dead code removal, then feature fixes, then architectural corrections
  - Created by: `Claude`
  ...
  - Reviewed at: `2026-04-01T17:34:51.403Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  - Review scope: campaign re-close of suspicious reviewed state
  - Skip reason: none
...
## CCP-474 - Performance Audit Full Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-474`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-484`, `CCP-490`, `CCP-496`, `CCP-502`, `CCP-507`
  ...
  - Task: execute all 5 performance audit phase managers in order: quick fixes, game library restructure, puzzle scaling, server/sync hardening, UI responsiveness
  - Created by: `Claude`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:55:12.098Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  ...
  - Manual checklist:
    - [ ] Games tab: pagination shows 50 games per page with Prev/Next controls
    - [ ] Import games: button shows game count after fetch completes
    - [ ] Analysis route cold load: skeleton board placeholder shown instead of bare Loading text
    - [ ] Stockfish engine loads from stockfish-web/ — no errors in console
    - [ ] public/stockfish/ directory no longer exists
    - [ ] Sync push: only recently changed records sent (check Network tab payload size on 2nd sync)
    - [ ] Sync pull: ?since= parameter appended to GET requests (check Network tab)
    - [ ] IDB records have updatedAt timestamps (check Application > IndexedDB)
    - [ ] Server batch inserts: no per-row INSERT loops (confirmed in code)
    - [ ] Puzzle data counts show correct numbers in admin sync UI
```

## CCP-475 - Fix Sync IDB Version Mismatch
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 1 — Critical Quick Fixes / 1.1`
  - Task: fix sync/client.ts opening patzer-pro IDB at version 1 instead of current version — extract shared version constant
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:06:02.480Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open dev console, navigate to /admin, push sync — confirm no VersionError in console
    - [ ] Open Application > IndexedDB in dev tools, verify patzer-pro db opens at version 5
```

## CCP-476 - Add 200ms Engine Update Throttle
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 1 — Critical Quick Fixes / 1.2`
  - Task: add 200ms throttle between engine output and redraw to match Lichess ceval pattern
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:06:06.027Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Already implemented: verify engine info lines in console show throttled UI updates (observe no frame drops during live analysis)
```

## CCP-477 - rAF-Gate the Redraw Function
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 1 — Critical Quick Fixes / 1.3`
  - Task: wrap redraw() in requestAnimationFrame gate to collapse multiple synchronous calls into one frame
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:06:09.484Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Navigate between routes, verify UI renders correctly (no blank frames)
    - [ ] Toggle engine on/off, verify eval bar and PV lines update properly
    - [ ] Navigate moves with arrows, verify board updates without lag
```

## CCP-478 - Throttle Wheel-Scroll Redraws
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 1 — Critical Quick Fixes / 1.4`
  - Task: add 50ms throttle to wheel event handler to prevent excessive move navigation during fast scrolling
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:06:16.787Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Scroll wheel over analysis board — moves advance at a controlled pace, no rapid fire
    - [ ] Trackpad scroll still works (pixel accumulator + throttle coexist)
```

## CCP-479 - Increase Lichess Import Max
...
- [x] Reviewed
  ...
  - Task: increase Lichess API game import limit from 30 to 300
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:06:20.200Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import games from Lichess — verify up to 300 games are fetched for an active account
    - [ ] Network tab shows max=300 in the Lichess API request URL
```

## CCP-480 - Add NNUE Prefetch Hint
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 1 — Critical Quick Fixes / 1.6`
  - Task: add link rel=prefetch for the NNUE weight file in index.html
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:06:23.622Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open Network tab, hard-reload page — verify nn-4ca89e4b3abf.nnue appears as a prefetch request before engine is toggled on
```

## CCP-481 - Request Persistent Storage
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 1 — Critical Quick Fixes / 1.7`
  - Task: call navigator.storage.persist() at app startup to prevent browser IDB eviction
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:06:26.935Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open dev console, run navigator.storage.persisted() — should return true (may require site engagement score)
    - [ ] No errors in console on page load
```

## CCP-482 - Cache filteredSummaries Result
...
- [x] Reviewed
  ...
  - Task: cache filteredSummaries() result to avoid recomputing on every access within a render cycle
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:06:30.515Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open /stats, change time filter — verify stats update correctly
    - [ ] Switch away and back to /stats — verify data still displays
```

## CCP-483 - Cache Game Summaries in Stats Controller
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 1 — Critical Quick Fixes / 1.9`
  - Task: prevent stats controller from re-loading all game summaries from IDB on every stats page entry
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:06:34.656Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Navigate to /stats, then away, then back — verify no loading flicker on re-entry when no new games analyzed
    - [ ] Analyze a game, then visit /stats — verify the new game appears in stats
    - [ ] Check dev console for no errors on stats page transitions
```

## CCP-484 - Phase 1 Critical Quick Fixes Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-484`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-475`, `CCP-476`, `CCP-477`, `CCP-478`, `CCP-479`, `CCP-480`, `CCP-481`, `CCP-482`, `CCP-483`
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 1 — Critical Quick Fixes`
  - Task: execute all 9 Phase 1 quick-fix prompts: sync version fix, engine throttle, rAF redraw, wheel throttle, import max, NNUE prefetch, persistent storage, summary caching
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:06:38.376Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Sync push/pull works without IDB VersionError (CCP-475)
    - [ ] Engine info lines are throttled at 200ms during live analysis (CCP-476, pre-existing)
    - [ ] UI renders without blank frames after rAF-gated redraw (CCP-477)
    - [ ] Wheel scroll over board advances moves at controlled pace (CCP-478)
    - [ ] Lichess import fetches up to 300 games (CCP-479)
    - [ ] NNUE file prefetched on page load (CCP-480)
    - [ ] navigator.storage.persisted() returns true (CCP-481)
    - [ ] Stats page filters update correctly with cached results (CCP-482)
    - [ ] Stats page skips IDB reload on re-entry when data unchanged (CCP-483)
```

## CCP-485 - Add Per-Game IDB Store Schema
...
- [x] Reviewed
  ...
  - Task: add new games object store with per-game records and indexes to patzer-pro IDB schema
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:13.050Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open DevTools > Application > IndexedDB, reload app, confirm 'games' store exists with keyPath 'id'
    - [ ] Confirm 'games' store has indexes: date, importedUsername, source, timeClass
    - [ ] Confirm DB version shows 6
    - [ ] Confirm existing stores (game-library, analysis-library, etc.) are unchanged
    - [ ] Import games and confirm no console errors on startup
```

## CCP-486 - Migrate Game Save Path to Per-Game Records
...
- [x] Reviewed
  ...
  - Task: update saveGamesToIdb to write individual game records to the new games store
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:14.063Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import games from Chess.com or Lichess, open DevTools > Application > IndexedDB > games store, confirm individual records appear keyed by id
    - [ ] Confirm game-library store still has the legacy 'imported-games' array record
    - [ ] Reload page, confirm games still appear in the list (legacy load path still works)
    - [ ] Check console for no errors during import
```

## CCP-487 - Migrate Game Load Path to On-Demand Reads
...
- [x] Reviewed
  ...
  - Task: update loadGamesFromIdb to read per-game records with on-demand PGN loading
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:15.076Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import games, reload page — confirm games list still populates correctly
    - [ ] In DevTools > Application > IndexedDB: after import, confirm 'games' store has individual records
    - [ ] On fresh page load (games store populated), confirm games still appear (new load path used)
    - [ ] Confirm 'game-library' legacy store still present for backward compat
    - [ ] No console errors during startup or import
```

## CCP-488 - Update Deduplication to Composite Keys
...
- [x] Reviewed
  ...
  - Task: replace full-PGN-string dedup Set with composite key or IDB key existence check
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:16.072Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import games from Chess.com or Lichess, confirm games appear normally in the list
    - [ ] Re-import the same username — confirm no duplicate games appear
    - [ ] Check console for no errors during import
```

## CCP-489 - Update Sync Client for Per-Game Records
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 2 — Game Library Restructure / 2.5`
  - Task: update sync client to read/write from per-game games store instead of legacy game-library store
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:17.058Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] As authenticated user: open Admin, click Push — confirm 'games' count reflects actual game count (not 1)
    - [ ] Pull from server — confirm games appear in the games store (DevTools > IndexedDB > games)
    - [ ] Admin data counts panel shows correct game count matching the games store
```

## CCP-490 - Phase 2 Game Library Restructure Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-490`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-485`, `CCP-486`, `CCP-487`, `CCP-488`, `CCP-489`
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 2 — Game Library Restructure`
  - Task: execute all 5 Phase 2 game library restructure prompts in strict order: schema, save path, load path, dedup, sync client
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:18.042Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import games from Chess.com or Lichess — confirm games appear in the list normally
    - [ ] Open DevTools > Application > IndexedDB > patzer-pro: confirm 'games' store exists (DB version 6), contains individual records keyed by id with indexes (date, importedUsername, source, timeClass)
    - [ ] Reload page after import — confirm games still load correctly (new per-game store load path)
    - [ ] Re-import same username — confirm no duplicates appear (composite key dedup working)
    - [ ] Admin panel: confirm Push shows accurate game count (not 1)
    - [ ] Clear Local Data in admin — confirm 'games' store is cleared along with others
```

## CCP-491 - Replace listPuzzleDefinitions getAll with Cursor
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 3 — Puzzle Subsystem Scaling / 3.1`
  - Task: replace getAll() in listPuzzleDefinitions with cursor-based pagination supporting limit and offset
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:19.027Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open /puzzles, navigate to the library tab — confirm puzzle counts appear correctly
    - [ ] Confirm user-library puzzles load and display in the list
    - [ ] Check console for no errors on library page load
```

## CCP-492 - Batch Retry Queue Construction
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 3 — Puzzle Subsystem Scaling / 3.2`
  - Task: replace serial per-puzzle getAttempts calls with single batched cursor scan grouped by puzzleId
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:20.020Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open /puzzles, start a retry session — confirm it loads and the first puzzle appears
    - [ ] Start a due-for-review session — confirm it loads without errors
    - [ ] Check console: no 'getAttempts' serial calls visible, no errors
```

## CCP-493 - Add Puzzle Attempt Retention Policy
...
- [x] Reviewed
  ...
  - Task: add pruneOldAttempts function keeping only most recent 20 attempts per puzzle
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:21.020Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Solve puzzles repeatedly — attempt count in DevTools > IndexedDB > attempts stays at or below 20 per puzzle after many solves
    - [ ] Solving a puzzle still works normally (no errors in console)
    - [ ] Retry queue and due queue still function correctly after pruning
```

## CCP-494 - Deduplicate Puzzle Attempts on Pull
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 3 — Puzzle Subsystem Scaling / 3.4`
  - Task: fix sync pull to filter puzzle attempts by max local completedAt before writing
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:22.040Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] As authenticated user: pull from server twice — confirm attempt count in DevTools > IndexedDB > puzzle-attempts does not grow on second pull
    - [ ] Pull with new server attempts (solve puzzles on another session then pull) — confirm new attempts are written
    - [ ] Admin panel shows attempt count unchanged after a repeated pull
```

## CCP-495 - Cap Shard Cache with LRU Eviction
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 3 — Puzzle Subsystem Scaling / 3.5`
  - Task: limit puzzle shard in-memory cache to 10 entries with LRU eviction via Map ordering
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:23.052Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open /puzzles and solve several puzzles across different rating ranges — confirm puzzles load and display correctly
    - [ ] No console errors during puzzle selection or shard loading
    - [ ] Solving puzzles from many different rating bands still works (cache eviction does not break re-fetch)
```

## CCP-496 - Phase 3 Puzzle Subsystem Scaling Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-496`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-491`, `CCP-492`, `CCP-493`, `CCP-494`, `CCP-495`
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 3 — Puzzle Subsystem Scaling`
  - Task: execute all 5 Phase 3 puzzle scaling prompts: cursor listing, batch retry queue, retention policy, dedup on pull, LRU shard cache
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:24.052Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open /puzzles, confirm library counts display correctly (user count, imported count)
    - [ ] Open user library list — confirm only user-library puzzles appear, no errors
    - [ ] Start a retry session — confirm queue builds and first puzzle loads
    - [ ] Start a due-for-review session — confirm queue builds and first puzzle loads
    - [ ] Solve a puzzle 25+ times — confirm attempt count stays at ≤20 per puzzle in DevTools > IndexedDB
    - [ ] As authenticated user: pull from server twice — confirm attempt count does not grow on second pull
    - [ ] Solve puzzles across many rating ranges — confirm shard cache doesn't grow unboundedly and puzzles still load
```

## CCP-497 - Batch Server Game Inserts
...
- [x] Reviewed
  ...
  - Task: replace sequential single-row upsertGame loop with batched multi-row INSERT statements (500 per batch)
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:25.036Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import 10+ games via Chess.com or Lichess, then push to server — confirm sync completes without error in dev console
    - [ ] Check server/data/patzer.db games table has correct rows after push
```

## CCP-498 - Batch Server Analysis and Puzzle Inserts
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 4 — Server & Sync Hardening / 4.2`
  - Task: apply batched multi-row INSERT pattern to analysis, puzzle definitions, attempts, and user meta tables
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:26.026Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Push analysis data to server after reviewing a game — confirm sync success in dev console
    - [ ] Push puzzle data to server — confirm definitions, attempts, and meta rows appear in SQLite
    - [ ] Verify no duplicate rows after repeated push
```

## CCP-499 - Add updatedAt Tracking for Differential Sync
...
- [x] Reviewed
  ...
  - Task: add updatedAt: Date.now() timestamps to all IDB write functions for sync-participating records
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:27.002Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import a game, open Application > IndexedDB > patzer-pro > games — confirm records have updatedAt field
    - [ ] Review a game, check analysis-library records for updatedAt field
    - [ ] Solve a puzzle, check patzer-puzzle-v1 > definitions and attempts for updatedAt field
    - [ ] Verify existing pre-migration records still load without errors (updatedAt is optional on puzzle types)
```

## CCP-500 - Implement Server-Side Since Parameter
...
- [x] Reviewed
  ...
  - Task: add ?since=timestamp query parameter to all GET sync endpoints with filtered query functions
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:27.984Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Start server, GET /api/sync/games returns all games (no since param)
    - [ ] GET /api/sync/games?since=0 returns all games (epoch 0 = everything)
    - [ ] GET /api/sync/games?since=9999999999999 returns empty array (future timestamp)
    - [ ] GET /api/sync/analysis?since=0 returns all analysis
    - [ ] GET /api/sync/puzzles?since=0 returns all definitions, attempts, meta
```

## CCP-501 - Update Sync Client for Differential Push/Pull
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 4 — Server & Sync Hardening / 4.5`
  - Task: update sync client to push only changed records and pull only records newer than lastSyncedAt
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:28.957Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] First sync (clear localStorage lastSyncedAt): push sends ALL records, pull fetches ALL records
    - [ ] Second sync: push sends only records changed since last sync, pull requests only ?since=timestamp
    - [ ] Open dev console Network tab during push — confirm request payload is smaller on second sync
    - [ ] Open dev console Network tab during pull — confirm server response is smaller on second sync
    - [ ] Verify puzzle data counts in admin UI show correct numbers after pull (store name fix)
    - [ ] Open Application > Local Storage — confirm lastSyncedAt updates after each successful sync
```

## CCP-502 - Phase 4 Server & Sync Hardening Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-502`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-497`, `CCP-498`, `CCP-499`, `CCP-500`, `CCP-501`
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 4 — Server & Sync Hardening`
  - Task: execute all 5 Phase 4 server/sync prompts: batch game inserts, batch other inserts, updatedAt tracking, server since param, differential sync client
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:12:29.965Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import games, push to server — confirm batched INSERT in server logs (not per-row)
    - [ ] Review a game, push analysis — confirm analysis data arrives in SQLite
    - [ ] Solve puzzles, push puzzle data — confirm definitions, attempts, meta in SQLite
    - [ ] Open Application > IndexedDB — confirm updatedAt on game records, analysis records, puzzle definitions, and attempts
    - [ ] First sync (clear lastSyncedAt): full push and pull, confirm all data transfers
    - [ ] Second sync: confirm only recently changed records are pushed/pulled (smaller payload in Network tab)
    - [ ] GET /api/sync/games?since=<recent_ts> — confirm only recent games returned
    - [ ] Verify puzzle data counts show correct numbers in admin UI after pull (store name bugfix)
```

## CCP-503 - Add Game List Pagination
...
- [x] Reviewed
  ...
  - Task: add simple pagination (50 per page) to game list view with prev/next buttons and page indicator
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Reviewed at: `2026-04-01T18:03:12.096Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Navigate to Games tab with 50+ games imported — confirm only 50 rows visible in table
    - [ ] Click Next — page 2 shows next 50 games, Prev button becomes enabled
    - [ ] Click Prev on page 1 — button is disabled
    - [ ] Apply a result filter (e.g. Wins) — page resets, shows filtered count
    - [ ] Clear filters — page resets to 1, full game count restored
```

## CCP-504 - Add Skeleton UI for Route Loading
...
- [x] Reviewed
  ...
  - Task: render page skeleton immediately on route change before async data loads complete
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Reviewed at: `2026-04-01T18:03:16.809Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Navigate to /analysis/<gameId> on first page load (cold start) — confirm board placeholder and tools placeholder appear instead of bare Loading text
    - [ ] After IDB loads, confirm full analysis board replaces the skeleton
    - [ ] Navigate to /analysis/<invalid-id> — confirm not-found message with link to games
```

## CCP-505 - Add Import Progress Counter
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 5 — UI Responsiveness / 5.3`
  - Task: show live game count during import instead of just Importing... text
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Reviewed at: `2026-04-01T18:03:20.644Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import from Chess.com — button shows Importing... then Importing... (N) after fetch completes with game count
    - [ ] Import from Lichess — same behavior, shows count after fetch completes
    - [ ] After import finishes, button reverts to Import text
    - [ ] If import returns 0 games, error message shown without count
```

## CCP-506 - Remove Unused Stockfish Directory
...
- [x] Reviewed
  ...
  - Task: verify and remove unused public/stockfish/ directory (keeping public/stockfish-web/)
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:03:23.998Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Confirm public/stockfish/ directory no longer exists
    - [ ] Open analysis board, enable engine, confirm Stockfish WASM loads from stockfish-web/ without errors
    - [ ] Check Network tab — no requests to public/stockfish/ path
```

## CCP-507 - Phase 5 UI Responsiveness Batch Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-507`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-503`, `CCP-504`, `CCP-505`, `CCP-506`
  - Source document: `docs/audits/PERFORMANCE_SCALABILITY_AUDIT_2026-03-30.md`
  - Source step: `Phase 5 — UI Responsiveness & Perceived Speed`
  - Task: execute all 4 Phase 5 UI responsiveness prompts: game list pagination, skeleton UI, import counter, stockfish cleanup
  - Created by: `Claude`
  - Created at: `2026-03-30T22:00:00Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:58.426Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  ...
  - Manual checklist:
    - [ ] Games tab with 50+ games: only 50 rows shown, Prev/Next pagination works
    - [ ] Navigate to /analysis/<gameId> cold — skeleton board+tools placeholder shown before IDB loads
    - [ ] Import games from Chess.com — button shows Importing... then game count after fetch
    - [ ] Enable Stockfish engine on analysis board — loads from stockfish-web/ without errors
    - [ ] Confirm public/stockfish/ directory is gone (no old 15MB Stockfish 16 files)
```

## CCP-510 - Rename Repertoire Tool to Opening Tree in Session Toolbar
...
- [x] Reviewed
  ...
  - Source document: `null`
  - Source step: `null`
  - Task: rename the 'repertoire' tool to 'opening-tree' with a branching icon in the session tool rail; add 'repertoire' back as a placeholder below it; remove the Repertoire identity label from inside the panel
  - Created by: `Claude`
  ...
  - Reviewed at: `2026-04-01T18:13:59.523Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open Opponent Research, open a collection — confirm top rail button shows 'Opening Tree' with a branching icon
    - [ ] Confirm clicking 'Opening Tree' shows the board and move list with no overview/summary/insight cards above it
    - [ ] Confirm clicking 'Repertoire' shows the overview, summary modules, and line insight cards without a board
    - [ ] Confirm Prep Report still works and navigating to a line from it switches to Opening Tree (not Repertoire)
    - [ ] Confirm Style and Practice show the coming-soon placeholder
```

## CCP-509 - Fix Stuck Importing Dialogue After Returning to Library
...
- [x] Reviewed
  ...
  - Source document: `null`
  - Source step: `null`
  - Task: fix _importStep never being reset to 'idle' on successful import — causes 'importing games' dialogue to stick when user returns to library after a completed import
  - Created by: `Claude`
  - Created at: `2026-03-30T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:08:06.061Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Click New Research, fill in opponent username, click Import, wait for session board to appear
    - [ ] Click ← Library — confirm the collection list appears, not the 'Importing games…' dialogue
    - [ ] Confirm the New Research button is visible in the library header
```

## CCP-508 - Fix Time Control Classification Thresholds
...
- [x] Reviewed
  ...
  - Source document: `null`
  - Source step: `null`
  - Task: fix timeClassFromTimeControl in src/import/types.ts — bullet/blitz thresholds are off by a step causing blitz games to appear in bullet column and actual bullet games to vanish on opponent research library cards
  - Created by: `Claude`
  - Created at: `2026-03-30T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:08:01.710Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Import Lichess games including 1+0 — confirm they appear under Bullet, not missing
    - [ ] Import 3+0 or 5+0 games — confirm they appear under Blitz, not Bullet
    - [ ] Import 10+0 games — confirm they appear under Rapid, not Blitz
    - [ ] Open Opponent Research library card — confirm speed columns match the imported game types
```

## CCP-470-F1 - Fix Bulk-Save Puzzle Flow — Preserve First-Attempt Outcomes
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-470-F1`
  - Parent prompt ID: `CCP-470`
  - Batch prompt IDs: none
  - Source document: `docs/audits/SPRINT_VS_IMPLEMENTATION_AUDIT_2026-03-30.md`
  - Source step: `Bug — bulk-save missing first-attempt data (follow-up)`
  - Task: fix or create the bulk-save puzzle flow to preserve first-attempt outcome data when saving multiple puzzles from a review session
  - Created by: `Claude`
  ...
  - Manual checklist:
    - [ ] Start a game review (retro) session, solve one candidate correctly (green), skip another, then exit retro mode — the candidates panel should appear
    - [ ] Save the candidate you solved during retro — open IDB in DevTools (Application > IndexedDB > patzer-pro > puzzle-library), confirm the saved record has retroOutcome: 'win'
    - [ ] Save the candidate you skipped — confirm retroOutcome: 'skip' on the saved record
    - [ ] Save a candidate without ever running a retro session — confirm retroOutcome is absent (undefined) on the saved record
    - [ ] Reload the page and re-open a game without running retro — confirm the candidates panel save button still works normally
```

## CCP-471-F1 - Move findRatedPuzzleFromShards to puzzleDb.ts
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-471-F1`
  - Parent prompt ID: `CCP-471`
  - Batch prompt IDs: none
  - Source document: `docs/audits/SPRINT_VS_IMPLEMENTATION_AUDIT_2026-03-30.md`
  - Source step: `Architectural — move findRatedPuzzleFromShards to puzzleDb.ts (follow-up)`
  - Task: move findRatedPuzzleFromShards/findRatedPuzzleInShards from ctrl.ts to puzzleDb.ts and update all call sites
  - Created by: `Claude`
  - Created at: `2026-03-30T23:30:00Z`
  ...
  - Manual checklist:
    - [ ] Open /puzzles and start a rated session — confirm puzzles load and are selectable normally
    - [ ] Play through a rated puzzle and confirm the next puzzle loads after solving
    - [ ] Open DevTools console and confirm no import or runtime errors on the puzzles page
    - [ ] Confirm that 'findRatedPuzzleInShards' no longer appears as a local function in ctrl.ts (grep or source check)
```

## CCP-511 - Openings Opponent Tool Suite Batch Manager
...
- [x] Reviewed
  ...
  - Task: Run 16 prompts implementing the Openings Opponent Tool Suite: prep report, style dashboard, practice against them, and cleanup
  - Created by: `Claude Code`
  ...
  - Reviewed at: `2026-04-01T19:35:56.025Z`
  - Reviewed by: `Claude`
  - Review method: `manager-plus-children`
  ...
  - Manual checklist:
    - [ ] Build passes: npm run build + npx tsc --noEmit
    - [ ] Open collection → all five tools in tool rail work (Opening Tree, Repertoire, Prep Report, Style, Practice)
    - [ ] Style tool: player card, axes, signals, first-move breakdown, form, and behavioral sections all render
    - [ ] Practice tool: color picker appears pre-session, session starts on color click, opponent auto-responds from repertoire
    - [ ] Prep Report: dashboard appears with sections
    - [ ] No console errors across all tool navigations
```

## CCP-512 - Fix Engine Section Position on Opening Tree Page
...
- [x] Reviewed
  ...
  - Task: restore the engine lines section (with on/off toggle) to the top of the opening tree page layout
  - Created by: `Claude`
  - Created at: `2026-03-30T00:00:00Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:08:12.138Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Navigate to the openings/opponents page
    - [ ] Confirm the engine on/off toggle button appears near the top of the right panel, above the played lines and sample games sections
    - [ ] Toggle engine on — confirm eval lines appear below the toggle, still in the upper portion of the panel
    - [ ] Toggle engine off — confirm eval lines disappear, toggle button remains at top
    - [ ] Scroll the panel — confirm engine controls do not reappear at the bottom
```

## CCP-513 - Color Toggle Buttons Show Username When Active
...
- [x] Reviewed
  ...
  - Task: show import username as subtle top-line text on the active color toggle button; constant height on both buttons
  - Created by: `Claude`
  - Created at: `2026-03-30T00:00:00Z`
  ...
  - Reviewed at: `2026-04-01T18:08:17.523Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] On the openings page with a username imported, confirm both buttons are the same height
    - [ ] Press WHITE — confirm username appears on the top line of the WHITE button in small subtle text, with WHITE label below
    - [ ] Press BLACK — confirm username moves to the BLACK button top line, disappears from WHITE button
    - [ ] Confirm button height does not change between active/inactive states
    - [ ] Import a long username — confirm it truncates with ellipsis rather than overflowing
```

## CCP-514 - Fix dead recency toggle in Prep Report
...
- [x] Reviewed
  ...
  - Parent prompt ID: none
  - Batch prompt IDs: none
  - Source document: `CCP-362 review`
  - Source step: `Dead recency toggle — recencyMode() not wired to analytics`
  - Task: Wire recencyMode() into computeLikelyLineModule and invalidate _prepReportCache on mode change
  - Created by: `Claude`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:08:33.418Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Navigate to /openings and load a collection
    - [ ] Open the Prep Report tab
    - [ ] With 'Recent' active, note the order of lines in the Likely Lines section
    - [ ] Click 'All time' — lines should reorder (sort by raw frequency, no recency boost)
    - [ ] Click 'Recent' again — order should return to the recency-boosted order
    - [ ] Confirm no console errors during toggle
```

## CCP-519 - Study domain types
...
- [x] Reviewed
  ...
  - Source step: `Phase 0 — Task 0.1`
  - Task: Create src/study/types.ts with all Study domain types: StudyItem, StudySource, TrainableSequence, PositionProgress, DrillAttempt. See sprint doc Phase 0 Task 0.1 for exact type definitions.
  - Created by: `Claude`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:40:38.596Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint task ID: `SPR-015-T01`
  - Completed at: `2026-03-31T15:22:02.157Z`
  - Manual checklist:
    - [ ] src/study/types.ts exists and exports StudyItem, StudySource, TrainableSequence, PositionProgress, DrillAttempt
    - [ ] npx tsc --noEmit passes with no errors from study types
    - [ ] No existing files were modified
```

## CCP-520 - Study IDB persistence layer
...
- [x] Reviewed
  ...
  - Reviewed at: `2026-04-01T17:40:43.298Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P1`
  - Sprint task ID: `SPR-015-T02`
  - Completed at: `2026-03-31T15:23:06.995Z`
  - Manual checklist:
    - [ ] Open app in browser, confirm existing games/analysis/puzzles still load (IDB v7 upgrade is non-destructive)
    - [ ] In DevTools Application > IndexedDB > patzer-pro, verify version is 7 and stores studies, practice-lines, position-progress, drill-attempts are present
    - [ ] npm run build passes
    - [ ] npx tsc --noEmit passes
```
...
- [x] Reviewed
  ...
  - Task: Fix studyDb so a fresh #/study boot cannot upgrade patzer-pro without creating the Phase 0 study stores.
  - Created by: `Codex`
  ...
  - Manual checklist:
    - [ ] Open #/study first in a fresh browser profile — expected result: library loads without missing-store errors and IndexedDB shows studies, practice-lines, position-progress, and drill-attempts
    - [ ] Reload the app and open analysis/game routes after opening #/study first — expected result: existing shared patzer-pro data still loads normally
    - [ ] Open DevTools Application > IndexedDB > patzer-pro after a fresh study-first boot — expected result: the four study stores exist with no upgrade/runtime console errors
```

## CCP-521 - Study route and page shell
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 0 — Task 0.3`
  - Task: Add #/study and #/study/:id routes to src/router.ts. Create src/study/libraryView.ts with minimal placeholder. Wire route dispatch in src/main.ts. Add Study to navigation menu.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:40:46.589Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P1`
  - Sprint task ID: `SPR-015-T03`
  - Completed at: `2026-03-31T15:24:29.375Z`
  - Manual checklist:
    - [ ] Navigate to #/study — see 'Study Library — coming soon' placeholder
    - [ ] Nav bar has a 'Study' link that is active when on #/study
    - [ ] Navigate to #/study/test-id — see 'Study detail — coming soon' placeholder
    - [ ] All existing routes (#/analysis, #/puzzles, #/opponents, #/stats) still work
    - [ ] npm run build passes
    - [ ] npx tsc --noEmit passes
```

## CCP-522 - Phase 0 Manager — Study Page Foundation — Types, Persistence, Route Shell
...
- [x] Reviewed
  ...
  - Task ID: `CCP-522`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-519`, `CCP-520`, `CCP-521`
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 0 — Study Page Foundation — Types, Persistence, Route Shell`
  - Task: Establish the data model, IDB stores, route, and empty page shell for the Study feature.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:54:58.538Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  ...
  - Manual checklist:
    ...
    - [ ] IDB patzer-pro at version 7 with studies, practice-lines, position-progress, drill-attempts stores
    - [ ] Existing games/analysis/puzzles data survives version bump
    - [ ] npx tsc --noEmit passes
    - [ ] All existing routes work
```

## CCP-523 - Save action core logic
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 1 — Task 1.1`
  - Task: Create src/study/saveAction.ts exporting saveCurrentToLibrary(pgn, metadata). Generates ID, populates defaults (title from PGN headers), timestamps, writes to IDB.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:17.414Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint task ID: `SPR-015-T04`
  - Completed at: `2026-03-31T15:25:42.074Z`
  - Manual checklist:
    - [ ] src/study/saveAction.ts exists and exports saveCurrentToLibrary
    - [ ] npx tsc --noEmit passes
    - [ ] (Browser test) Call saveCurrentToLibrary('1. e4 e5') from console — verify a StudyItem appears in IDB > patzer-pro > studies
```

## CCP-524 - Context menu — Save to Library
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 1 — Task 1.2`
  - Task: Add "Save to Library" menu item to renderContextMenu() in src/main.ts. On click, call saveCurrentToLibrary() with current game PGN and metadata.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:18.390Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P2`
  - Sprint task ID: `SPR-015-T05`
  - Completed at: `2026-03-31T15:27:36.472Z`
  - Manual checklist:
    - [ ] Right-click any move in move list → 'Save to Library' menu item appears
    - [ ] Click 'Save to Library' → flash message 'Saved to Library' appears
    - [ ] In DevTools Application > IndexedDB > patzer-pro > studies, a record appears with correct PGN and metadata
    - [ ] No console errors
```

## CCP-525 - Board menu — Save game to Library
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 1 — Task 1.3`
  - Task: Add "Save game to Library" to the analysis controls hamburger menu in src/analyse/analysisControls.ts.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:19.368Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P2`
  - Sprint task ID: `SPR-015-T06`
  - Completed at: `2026-03-31T15:31:55.311Z`
  - Manual checklist:
    - [ ] Open analysis page → click hamburger menu (☰) → 'Save game to Library' button appears at top of Tools section
    - [ ] Click it → flash message 'Saved to Library' appears
    - [ ] DevTools > Application > IndexedDB > patzer-pro > studies — record exists with correct PGN
```

## CCP-526 - Toast notification system
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 1 — Task 1.4`
  - Task: Create src/ui/toast.ts with showToast(message, durationMs?) function. Auto-dismiss after 2 seconds with CSS fade animation. Wire into save actions.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:20.383Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P2`
  - Sprint task ID: `SPR-015-T07`
  - Completed at: `2026-03-31T15:34:58.011Z`
  - Manual checklist:
    - [ ] Right-click a move → 'Save to Library' → toast appears at bottom of screen and auto-dismisses
    - [ ] Open hamburger menu → 'Save game to Library' → toast appears and auto-dismisses
    - [ ] Toast does not interfere with board or other UI elements
    - [ ] npm run build passes (CSS compiled)
```

## CCP-527 - Phase 1 Manager — Save Action — Save to Library from Anywhere
...
- [x] Reviewed
  ...
  - Task ID: `CCP-527`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-523`, `CCP-524`, `CCP-525`, `CCP-526`
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 1 — Save Action — Save to Library from Anywhere`
  - Task: Users can save any game from any surface to the Study Library with one click.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:38.251Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    ...
    - [ ] StudyItem appears in IDB with correct PGN, metadata, source='analysis'
    - [ ] Multiple saves produce separate records with unique IDs
    - [ ] No console errors on any page
```

## CCP-528 - Study library controller
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:21.366Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint task ID: `SPR-015-T08`
  - Completed at: `2026-03-31T15:36:01.925Z`
  - Manual checklist:
    - [ ] src/study/studyCtrl.ts exists with initStudyLibrary, studies(), updateStudy(), deleteStudy() exports
    - [ ] npx tsc --noEmit passes
```

## CCP-529 - Library list view
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 2 — Task 2.2`
  - Task: Replace placeholder in src/study/libraryView.ts with full library browser: header, filter bar, sort controls, study list rows, empty state, click-to-navigate.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:22.366Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P3`
  - Sprint task ID: `SPR-015-T09`
  - Completed at: `2026-03-31T16:08:15.943Z`
  - Manual checklist:
    - [ ] Navigate to #/study — library browser renders (not placeholder)
    - [ ] If studies exist: rows show title, source, date, tags, favorite star
    - [ ] Sort controls work (click Date saved / Title / Last modified)
    - [ ] Favorite star toggles and persists across page reload
    - [ ] Empty state shows 'No studies yet' when library is empty
    - [ ] Clicking a study row navigates to #/study/:id
```

## CCP-530 - Study metadata editing
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 2 — Task 2.3`
  - Task: Add inline editing to library view: editable title, tag editor with add/remove, folder selector, favorite toggle, notes textarea. Persist via updateStudy().
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:23.369Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P3`
  - Sprint task ID: `SPR-015-T10`
  - Completed at: `2026-03-31T16:09:44.050Z`
  - Manual checklist:
    - [ ] Click ▼ expand button on a study row → expanded section appears with Notes textarea and Folder input
    - [ ] Edit a title (click it) → blur → title updates and persists across page reload
    - [ ] Add a tag → tag appears as pill with × remove button → persists
    - [ ] Add a note → blur → note persists across page reload
    - [ ] Add a folder → folder appears as green pill → persists
```

## CCP-531 - PGN import to library
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 2 — Task 2.4`
  - Task: Add Import PGN button in library header. Modal with textarea + file upload. Parse via chessops parsePgn(). Multi-game PGNs become separate StudyItems.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:24.364Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P3`
  - Sprint task ID: `SPR-015-T11`
  - Completed at: `2026-03-31T16:33:23.356Z`
  - Manual checklist:
    - [ ] Click 'Import PGN' button → modal appears with textarea and file upload
    - [ ] Paste a single-game PGN → click Import → study appears in library
    - [ ] Paste a multi-game PGN (2+ games) → click Import → each game appears as a separate study row
    - [ ] Upload a .pgn file → games are imported
    - [ ] Empty paste → shows 'Paste a PGN first' error message
    - [ ] Close modal (× or backdrop click) → modal dismisses
```

## CCP-532 - Phase 2 Manager — Study Library Browser
...
- [x] Reviewed
  ...
  - Task ID: `CCP-532`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-528`, `CCP-529`, `CCP-530`, `CCP-531`
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 2 — Study Library Browser`
  - Task: A browsable, filterable, sortable library of saved studies at #/study.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:39.243Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    ...
    - [ ] Each row: title, source, date, tags, favorite star
    - [ ] Sort controls work (date, title, last modified)
    ...
    - [ ] PGN import: paste multi-game PGN → all games appear as separate studies
    - [ ] Empty state shows when no studies exist
    - [ ] Click study row → navigates to #/study/:id
```

## CCP-533 - Study detail page shell with board
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 3 — Task 3.1`
  - Task: Create src/study/studyDetailView.ts. Load StudyItem, parse PGN to TreeNode, render own Chessground instance + move list + nav controls. CRITICAL: investigate board deps on AnalyseCtrl first.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:25.350Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint task ID: `SPR-015-T12`
  - Completed at: `2026-03-31T16:37:44.615Z`
  - Manual checklist:
    - [ ] Navigate to #/study/:id (a saved study's ID) → board renders with the game
    - [ ] Move list shows the game's moves
    - [ ] Click a move in the list → board updates to that position
    - [ ] Nav bar buttons (first/prev/next/last) navigate correctly
    - [ ] Flip board button (⇅) works
    - [ ] Existing analysis page (/) is unaffected — no shared board state pollution
```

## CCP-534 - Text comment editing
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 3 — Task 3.2`
  - Task: Create src/study/annotationCtrl.ts and annotationView.ts. Comment panel below move list. Textarea editing, save on blur/Enter, update TreeNode.comments.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:26.339Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P4`
  - Sprint task ID: `SPR-015-T13`
  - Completed at: `2026-03-31T16:48:23.810Z`
  - Manual checklist:
    - [ ] Open a study at #/study/:id → comment panel appears below move list
    - [ ] Click '+ Add comment' → textarea appears focused
    - [ ] Type a comment → blur or Enter → comment text displays
    - [ ] Navigate to another move and back → comment persists (in memory)
    - [ ] Click existing comment → editable again
```

## CCP-535 - NAG glyph insertion
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 3 — Task 3.3`
  - Task: Add glyph toolbar: buttons for !, ?, !!, ??, !?, ?!, =, +=, +/-, +-. Keyboard shortcuts. Updates TreeNode.glyphs.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:27.329Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P4`
  - Sprint task ID: `SPR-015-T14`
  - Completed at: `2026-03-31T16:57:42.672Z`
  - Manual checklist:
    - [ ] Glyph toolbar shows below move list with !, ?, !!, ??, !?, ?!, =, +=, +/-, +- buttons
    - [ ] Click a glyph button → glyph appears on the current move (active state)
    - [ ] Click again → glyph removed
    - [ ] Click board column (tab to focus) → type '!' → quick-select popup appears with !-family glyphs
    - [ ] Select a glyph from quick-select → applied and popup dismisses
    - [ ] Press Escape → quick-select dismisses
```

## CCP-536 - Variation creation and management
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 3 — Task 3.4`
  - Task: Enable variation creation in study board (non-mainline move → addNode). Context menu for promote/delete. Reuse tree ops.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:28.318Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P4`
  - Sprint task ID: `SPR-015-T15`
  - Completed at: `2026-03-31T17:02:00.511Z`
  - Manual checklist:
    - [ ] Open a study with multiple variations in the move list
    - [ ] Right-click (or long-press on touch) a variation move — context menu should appear at cursor position
    - [ ] Click 'Promote variation' — variation should move up one level in the tree
    - [ ] Click 'Make main line' — variation should become the mainline
    - [ ] Click 'Delete from here' — node and all descendants should be removed; board navigates to parent if current path was affected
    - [ ] Click outside the context menu — it should close without action
    - [ ] Right-click a mainline move — only 'Delete from here' should appear (no promote options)
    - [ ] Inline delete button (×) on variation rows still works independently
```

## CCP-537 - Variation fold/expand
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 3 — Task 3.5`
  - Task: Add fold/expand toggles to variation branch points. Triangle icon. Click to toggle visibility. Ephemeral state.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:29.337Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P4`
  - Sprint task ID: `SPR-015-T16`
  - Completed at: `2026-03-31T20:31:49.936Z`
  - Manual checklist:
    - [ ] Open a study with multiple variations in the move list
    - [ ] Confirm a ▼ triangle appears before each variation block
    - [ ] Click ▼ — variations should collapse and triangle changes to ▶
    - [ ] Click ▶ — variations should expand again
    - [ ] Navigate moves while variations are folded — board still responds to nav correctly
    - [ ] Fold state is ephemeral: reload study page resets all folds to expanded
    - [ ] Analysis board move list (non-study) is unaffected — no fold buttons visible there
```

## CCP-538 - Arrow and shape persistence
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 3 — Task 3.6`
  - Task: Hook Chessground drawable.onChange to save shapes on TreeNode.shapes. Restore on navigation. Serialize as [%cal]/[%csl].
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:30.325Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P4`
  - Sprint task ID: `SPR-015-T17`
  - Completed at: `2026-03-31T20:36:24.986Z`
  - Manual checklist:
    - [ ] Open a study and navigate to a move
    - [ ] Right-click drag to draw an arrow on the board — arrow should appear
    - [ ] Navigate away to another move, then back — arrow should be restored on return
    - [ ] Draw a square highlight (right-click without drag) — should persist on navigation
    - [ ] Clear all shapes (right-click empty square) — node should have no shapes after clear
    - [ ] Navigate forward through multiple moves, each having different saved shapes — each position restores its own shapes
    - [ ] Reload the study page — shapes are lost (ephemeral in this sprint, not yet serialized to PGN)
```

## CCP-539 - Engine analysis in study workspace
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 3 — Task 3.7`
  - Task: Add engine toggle in study detail. Start Stockfish on current position. Compact eval display. Cancel/restart on navigation.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:31.313Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P4`
  - Sprint task ID: `SPR-015-T18`
  - Completed at: `2026-03-31T20:46:48.162Z`
  - Manual checklist:
    - [ ] Open a study and navigate to any move
    - [ ] Click the ⚙ button in the nav bar — button should highlight and 'loading…' or depth appears below the nav bar
    - [ ] Wait a moment — score (e.g. +0.3) and depth (e.g. depth 15) should appear in the eval bar
    - [ ] Navigate to a different move — engine restarts and shows the new position's eval
    - [ ] Click ⚙ again — engine stops and eval bar disappears
    - [ ] Re-enable engine, then navigate using keyboard arrows — eval updates on each navigation
    - [ ] If engine was never started, no eval bar should be visible
```

## CCP-540 - Position bookmarking
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 3 — Task 3.8`
  - Task: Bookmark icon on moves. Toggle bookmarks on TreePaths. Highlight bookmarked positions. Filter toggle. Store as bookmarks[] on StudyItem.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:32.313Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P4`
  - Sprint task ID: `SPR-015-T19`
  - Completed at: `2026-03-31T20:50:49.980Z`
  - Manual checklist:
    - [ ] Open a study with moves
    - [ ] Hover over a move — a ☆ icon should appear next to it
    - [ ] Click ☆ — move highlights gold/amber indicating it's bookmarked, icon fills to ★
    - [ ] Click ★ again — bookmark is removed
    - [ ] Navigate to a bookmarked move — a ★ indicator appears in the toolbar above the move list
    - [ ] Bookmarks persist across navigation within the same session
    - [ ] Click '☆ Bookmarks' filter button — button highlights; move list still shows all moves (filter display only)
    - [ ] Reload study — bookmarks are restored from IDB (persisted on StudyItem)
```

## CCP-541 - Auto-save and PGN export
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 3 — Task 3.9`
  - Task: Debounced auto-save (500ms). Tree-to-PGN serializer preserving comments, NAGs, shapes. Copy PGN and Download PGN buttons.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T18:15:08.473Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P4`
  - Sprint task ID: `SPR-015-T20`
  - Completed at: `2026-03-31T20:56:53.243Z`
  - Manual checklist:
    - [ ] Open a study, make some moves, add a comment to a node
    - [ ] Click 'Copy PGN' — paste into a text editor, verify PGN headers and moves are present
    - [ ] If you added a comment, verify it appears as { comment text } in the PGN
    - [ ] Add a glyph (e.g. \!) to a move, copy PGN — verify  appears after that move
    - [ ] Draw an arrow on the board, navigate away and back, copy PGN — verify [%cal ...] appears in comments
    - [ ] Click 'Download PGN' — a .pgn file should download with the study title as filename
    - [ ] Make a move or edit, wait 1 second — auto-save should trigger (no visible indicator but reload should preserve changes)
```

## CCP-542 - Phase 3 Manager — Study Detail — Annotation Workspace
...
- [x] Reviewed
  ...
  - Task ID: `CCP-542`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-533`, `CCP-534`, `CCP-535`, `CCP-536`, `CCP-537`, `CCP-538`, `CCP-539`, `CCP-540`, `CCP-541`
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 3 — Study Detail — Annotation Workspace`
  - Task: Full-featured game annotation environment with board, move list, comments, glyphs, arrows, engine, variations, bookmarks, and auto-save.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:40.237Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    ...
    - [ ] Move list shows full game; click a move or use arrow keys to navigate
    - [ ] Type a comment in the comment panel — persists across navigation and reload
    - [ ] Click a glyph (!) on a move — persists on reload
    - [ ] Press ! with board focused — quick-select picker appears
    - [ ] Play a different move — variation created and visible in move list
    - [ ] Right-click a variation move — context menu with promote/delete options
    - [ ] Click ▼ before a variation block — collapses; click ▶ — expands
    - [ ] Draw an arrow, navigate away and back — arrow reappears
    - [ ] Click ⚙ engine toggle — eval score + depth appears
    - [ ] Click ★ bookmark on a move — highlighted in gold
    - [ ] Make changes, wait 1s, reload — changes persist
    - [ ] Click Copy PGN or Download PGN — output includes comments, glyphs, and arrows
```

## CCP-543 - Scheduling engine
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 4 — Task 4.1`
  - Task: Create src/study/practice/scheduler.ts: INTERVALS_MS, scheduleNext(), isDue(), positionKey(). Pure functions.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:33.295Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint task ID: `SPR-015-T21`
  - Completed at: `2026-03-31T21:39:03.678Z`
  - Manual checklist:
    - [ ] scheduleNext(3, true) returns {newLevel: 4, nextDueAt: ~2 weeks from now}
    - [ ] scheduleNext(5, false) returns {newLevel: 4, nextDueAt: ~2 weeks from now}
    - [ ] scheduleNext(1, false) returns {newLevel: 1, nextDueAt: ~1 day} (floor at 1)
    - [ ] scheduleNext(6, true) returns {newLevel: 6, nextDueAt: ~3 months} (ceiling at 6)
    - [ ] isDue({level:0, nextDueAt:0}) returns true (unlearned always due)
    - [ ] isDue({level:3, nextDueAt: Date.now()+99999}) returns false
    - [ ] positionKey('rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1') returns 'rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3'
```
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 4 — Task 4.2`
  - Task: Create src/study/practice/grader.ts: gradeMove(userSan, expectedSan, alternatives?). Pure function.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:34.288Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P5`
  - Sprint task ID: `SPR-015-T22`
  - Completed at: `2026-03-31T21:39:29.046Z`
  - Manual checklist:
    - [ ] gradeMove('Nf3', 'Nf3') returns 'correct'
    - [ ] gradeMove('e4', 'Nf3') returns 'incorrect'
    - [ ] gradeMove('O-O', 'O-O-O') returns 'incorrect'
    - [ ] gradeMove('e4', 'd4', ['e4', 'c4']) returns 'correct' (via alternatives)
    - [ ] gradeMove(' Nf3 ', 'Nf3') returns 'correct' (whitespace trimmed)
```

## CCP-545 - Drill session controller
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 4 — Task 4.3`
  - Task: Create src/study/practice/drillCtrl.ts: createDrillSession factory. State machine with feedback states, retry logic, sequence advancement, callbacks.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:35.276Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P5`
  - Sprint task ID: `SPR-015-T23`
  - Completed at: `2026-03-31T21:40:02.753Z`
  - Manual checklist:
    - [ ] createDrillSession([seq]) with seq.sans=['e4','Nf3'] → feedback='waiting', positionIndex=0
    - [ ] submitMove('e4') → feedback='correct', positionIndex still 0 (awaiting advance())
    - [ ] advance() → feedback='waiting', positionIndex=1
    - [ ] submitMove('d4') (wrong) → feedback='incorrect', attemptsAtPosition=1
    - [ ] submit wrong 2 more times → feedback='showAnswer' after 3rd wrong
    - [ ] After showAnswer, advance() → moves to next position or sequence
    - [ ] After last position in sequence, advance() moves to next sequence or isDone=true
```

## CCP-546 - Session builder
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 4 — Task 4.4`
  - Task: Create src/study/practice/sessionBuilder.ts: buildReviewSession(), buildLearnSession(), countDuePositions(). Pure functions.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:36.267Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P5`
  - Sprint task ID: `SPR-015-T24`
  - Completed at: `2026-03-31T21:40:33.183Z`
  - Manual checklist:
    - [ ] buildReviewSession with 3 sequences, 1 having a due position → returns only that sequence
    - [ ] buildReviewSession sorts by earliest nextDueAt (most overdue first)
    - [ ] buildLearnSession returns sequences with no progress or level=0
    - [ ] buildLearnSession sorts by createdAt ascending
    - [ ] countDuePositions returns correct count of due positions across all sequences
    - [ ] maxSequences limit is respected in both build functions
```

## CCP-547 - Practice line extraction
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:37.260Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P5`
  - Sprint task ID: `SPR-015-T25`
  - Completed at: `2026-03-31T21:41:14.078Z`
  - Manual checklist:
    - [ ] extractMainline(root, ...) with a root having 3 mainline moves → sequence with 3 moves/sans/fens
    - [ ] extractMainline returns null for a root with no children
    - [ ] extractVariationLine walks the specified path then continues down mainline
    - [ ] extractVariationLine returns null if path contains an unknown node id
    - [ ] deriveFens('startFen', ['e2e4']) returns one FEN string
    - [ ] deriveFens returns null if a UCI is invalid
    - [ ] All modules import/typecheck cleanly with no errors
```

## CCP-548 - Phase 4 Manager — Repetition Practice — Core Engine
...
- [x] Reviewed
  ...
  - Task ID: `CCP-548`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-543`, `CCP-544`, `CCP-545`, `CCP-546`, `CCP-547`
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phase 4 — Repetition Practice — Core Engine`
  - Task: Pure logic layer: scheduling, grading, drill session control. No UI — testable TypeScript modules only.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:14:41.223Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  - Review scope: re-review after missing provenance
  - Skip reason: none
  ...
  - Manual checklist:
    ...
    - [ ] scheduleNext(3, true) → {newLevel:4, nextDueAt: ~2 weeks out}
    - [ ] scheduleNext(5, false) → {newLevel:4, nextDueAt: ~2 weeks} (floor at max(1, level-1))
    - [ ] gradeMove('Nf3','Nf3') → 'correct'; gradeMove('e4','Nf3') → 'incorrect'
    - [ ] createDrillSession: correct move → feedback='correct'; 3 wrong → feedback='showAnswer'
    - [ ] buildReviewSession returns only sequences with due positions, sorted by earliest nextDueAt
    - [ ] extractMainline returns TrainableSequence with correct moves/sans/fens from tree
    - [ ] All modules are pure: no IDB imports, no DOM, no Snabbdom
```
...
- [x] Reviewed
  ...
  - Sprint task ID: `SPR-015-T26`
  - Completed at: `2026-04-01T19:40:21.374Z`
  - Manual checklist:
    - [ ] boardAdapter.ts exports createDrillBoardAdapter — confirm no build errors
    - [ ] drillView (Task 5.2) wires boardAdapter to a Chessground instance and calls setPosition/enableUserInput in sequence
```
...
- [x] Reviewed
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P6`
  - Sprint task ID: `SPR-015-T28`
  - Completed at: `2026-04-01T19:56:43.732Z`
  - Manual checklist:
    - [ ] Complete all positions in a drill session — summary appears with positions quizzed, accuracy %, lines completed X/N, duration
    - [ ] Click 'End Session' mid-drill — summary appears with stats captured at that point
    - [ ] Click 'Practice Again' — drill restarts from the beginning
    - [ ] Click 'Back to Library' — returns to study library view
```
...
- [x] Reviewed
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P6`
  - Sprint task ID: `SPR-015-T29`
  - Completed at: `2026-04-01T19:59:16.571Z`
  - Manual checklist:
    - [ ] Open any study detail — confirm 'Practice this line' button appears in header actions
    - [ ] Click 'Practice this line' — color picker overlay appears with White and Black buttons
    - [ ] Click 'White' or 'Black' — drill session starts with board oriented correctly
    - [ ] Board shows first position; 'Your turn' appears in feedback strip
    - [ ] Click 'End Session' from drill — returns to study annotation workspace
```

## CCP-553 - Phase 5 Manager — Repetition Practice — Board and UI
...
- [x] Reviewed
  ...
  - Task: Wire drill engine to Chessground and build the complete drill session UI.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  - Started at: not started
  - Skipped at: not skipped
  ...
  - Reviewed at: `2026-04-01T18:13:03.487Z`
  - Reviewed by: `Codex`
...
- [x] Reviewed
  ...
  - Sprint task ID: `SPR-015-T30`
  - Completed at: `2026-04-01T20:07:07.018Z`
  - Manual checklist:
    - [ ] Complete a drill with correct and incorrect moves — open DevTools > Application > IndexedDB > patzer-pro > position-progress and confirm records exist with non-zero levels
    - [ ] Check drill-attempts store — confirm records with correct/incorrect results, expectedMove, and timestamp
    - [ ] Verify PositionProgress.level increments on repeated correct answers and decrements on incorrect
```
...
- [x] Reviewed
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P7`
  - Sprint task ID: `SPR-015-T31`
  - Completed at: `2026-04-01T20:15:35.768Z`
  - Manual checklist:
    - [ ] Navigate to /study — if no practice data exists, banner is hidden
    - [ ] After completing a drill session: navigate back to library — banner shows 'X positions due for review'
    - [ ] Study rows show a 'N due' indicator when that study has due positions
    - [ ] 'Start Review' button launches a drill session with due sequences
    - [ ] Learn Now button appears for sequences with level-0 positions
```
...
- [x] Reviewed
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P7`
  - Sprint task ID: `SPR-015-T32`
  - Completed at: `2026-04-01T20:19:27.110Z`
  - Manual checklist:
    - [ ] Start drill with mode='learn' — board auto-plays all moves at ~700ms each without user interaction
    - [ ] After learn pass completes, confirm board transitions to quiz mode (feedback strip shows 'Your turn')
    - [ ] Check IDB position-progress after learn completes — all positions should have level=1
    - [ ] Quiz mode works normally after learn pass
```

## CCP-557 - Phase 6 Manager — Scheduling and Review
...
- [x] Reviewed
  ...
  - Task: Connect scheduling to persistence and build the practice dashboard with due counts.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  - Started at: not started
  - Skipped at: not skipped
  ...
  - Reviewed at: `2026-04-01T18:13:04.462Z`
  - Reviewed by: `Codex`
  - Review method: `manager-only`
  - Review scope: manager-only review of never-executed batch
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Sprint task ID: `SPR-015-T33`
  - Completed at: `2026-04-01T20:34:33.967Z`
  - Manual checklist:
    - [ ] Right-click any move in a study — context menu shows 'Practice from here'
    - [ ] Click 'Practice from here' — color picker appears
    - [ ] Select a color — drill starts from that position onwards (not from the beginning of the game)
    - [ ] Board is oriented for the selected color
```
...
- [x] Reviewed
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P8`
  - Sprint task ID: `SPR-015-T34`
  - Completed at: `2026-04-01T20:37:30.029Z`
  - Manual checklist:
    - [ ] Open a study detail — Practice Lines panel appears in tools column below comment panel
    - [ ] After creating a practice line via 'Practice this line', it appears in the panel
    - [ ] '▶' Practice now button launches drill for that specific line
    - [ ] Pause/resume button toggles line status (active ↔ paused)
    - [ ] Delete (✕) removes line from the panel and IDB
    - [ ] Double-click label to rename; Enter confirms, Escape cancels
```
...
- [x] Reviewed
  ...
  - Sprint ID: `SPR-015`
  - Sprint phase ID: `SPR-015-P8`
  - Sprint task ID: `SPR-015-T35`
  - Completed at: `2026-04-01T20:41:17.358Z`
  - Manual checklist:
    - [ ] Open a study chapter with multiple moves, click 'Practice this line' — confirm color picker shows scope selector at top (Full game / From current position / Selected variation)
    - [ ] Navigate to a specific move in the tree, open picker — confirm 'From current position' scope is selectable
    - [ ] Select 'Full game', choose White — confirm drill starts from move 1
    - [ ] Right-click a move to open context menu, click 'Practice from here' — confirm picker shows NO scope selector, just color buttons
    - [ ] Select a variation in the tree, open picker, choose 'Selected variation' — confirm drill starts from that variation path
```

## CCP-561 - Phase 7 Manager — Practice Line Selection and Management
...
- [x] Reviewed
  ...
  - Task: Users can select where practice begins and manage multiple lines per study.
  - Created by: `Claude`
  - Created at: `2026-03-31T06:37:40.000Z`
  - Started at: not started
  - Skipped at: not skipped
  ...
  - Reviewed at: `2026-04-01T18:13:05.464Z`
  - Reviewed by: `Codex`
  - Review method: `manager-only`
  - Review scope: manager-only review of never-executed batch
  - Skip reason: none
...
- [x] Reviewed
  ...
  - Task ID: `CCP-563`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-522`, `CCP-527`, `CCP-532`, `CCP-542`, `CCP-548`
  - Source document: `docs/mini-sprints/STUDY_PAGE_SPRINT_2026-03-31.md`
  - Source step: `Phases 0-4 Sequential Execution`
  - Task: Execute Study Page Phases 0 through 4 sequentially: Foundation, Save Action, Library Browser, Annotation Workspace, Drill Engine
  - Created by: `Claude`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:55:11.995Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  ...
  - Manual checklist:
    ...
    - [ ] Import PGN modal works (paste or file upload creates study entries)
    - [ ] Study rows expand showing notes/folder editor
    - [ ] #/study/:id loads the annotation workspace with board + move list
    - [ ] Navigation (click moves, arrow keys, first/last/prev/next buttons) works
    - [ ] Comments, glyphs, shapes all persist across navigation and page reload
    - [ ] Variations: play a different move → variation appears; context menu promotes/deletes
    - [ ] Fold/expand toggles work on variation branch points
    - [ ] Engine toggle shows live eval and updates on navigation
    - [ ] Bookmarks: toggle on moves, filter button in toolbar
    - [ ] Copy PGN and Download PGN produce correct annotated PGN
    - [ ] Auto-save fires 500ms after any change
    - [ ] Practice modules (scheduler, grader, drillCtrl, sessionBuilder, extractLine) typecheck cleanly
```

## CCP-564 - Engine Strength Levels Full Sprint Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-564`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-565`, `CCP-571`, `CCP-577`, `CCP-582`, `CCP-587`
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Full Sprint Manager`
  - Task: execute all engine strength level sprint phase managers in order
  - Created by: `Claude`
  ...
  - Manual checklist:
    ...
    - [ ] Engine strength types, protocol, ctrl, playMove, strengthView all present
    - [ ] Practice Against Them integration wired
    - [ ] Strength selector UI rendered
```

## CCP-565 - Strength Types And UCI Integration Phase Manager
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-565`
  - Parent prompt ID: `CCP-564`
  - Batch prompt IDs: `CCP-566`, `CCP-567`, `CCP-568`, `CCP-569`
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 1 manager`
  - Task: execute Phase 1 child prompts in order
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Sprint task ID: `SPR-003-T01`
  - Completed at: `2026-03-31T16:48:53.131Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
```

## CCP-566 - Audit SF18 WASM UCI Options For Strength Limiting
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-566`
  - Parent prompt ID: `CCP-565`
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 1 / Task 1.1`
  - Task: research Stockfish 18 WASM strength-limiting UCI options
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P1`
  - Sprint task ID: `SPR-003-T02`
  - Completed at: `2026-03-31T16:35:53.501Z`
  - Manual checklist:
    - [ ] Confirm UCI_LimitStrength and UCI_Elo are available in SF18 WASM
    - [ ] Confirm Skill_Level is deprecated in favor of UCI_Elo
    - [ ] Confirm depth capping is required alongside UCI_Elo
```

## CCP-567 - Define EngineMode EngineStrengthConfig And STRENGTH_LEVELS
...
- [x] Reviewed
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:52:09.545Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P1`
  - Sprint task ID: `SPR-003-T03`
  - Completed at: `2026-03-31T16:36:26.890Z`
  - Manual checklist:
    - [ ] Verify types compile and exports are correct
    - [ ] Verify build passes
```

## CCP-568 - Add Play Mode UCI Methods To StockfishProtocol
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 1 / Task 1.3`
  - Task: add setPlayStrength, setAnalysisMode, goPlay to protocol
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:52:14.223Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P1`
  - Sprint task ID: `SPR-003-T04`
  - Completed at: `2026-03-31T16:37:01.019Z`
  - Manual checklist:
    - [ ] Verify types compile and exports are correct
    - [ ] Verify build passes
```

## CCP-569 - Phase 1 Build And Typecheck Validation
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 1 / Task 1.4`
  - Task: validate Phase 1 build and typecheck
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:52:19.606Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P1`
  - Sprint task ID: `SPR-003-T05`
  - Completed at: `2026-03-31T16:48:47.684Z`
  - Manual checklist:
    - [ ] Verify types compile and exports are correct
    - [ ] Verify build passes
```

## CCP-571 - Engine Mode Switching Phase Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-571`
  - Parent prompt ID: `CCP-564`
  - Batch prompt IDs: `CCP-572`, `CCP-573`, `CCP-574`, `CCP-575`
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 2 manager`
  - Task: execute Phase 2 child prompts in order
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Sprint task ID: `SPR-003-T06`
  - Completed at: `2026-03-31T16:51:32.895Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-572 - Trace Engine Lifecycle And Mode Switch Injection Points
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-572`
  - Parent prompt ID: `CCP-571`
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 2 / Task 2.1`
  - Task: research engine lifecycle and safe mode-switch points
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P2`
  - Sprint task ID: `SPR-003-T07`
  - Completed at: `2026-03-31T16:50:03.625Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-573 - Add EngineMode EnterPlayMode ExitPlayMode To Ctrl
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 2 / Task 2.2`
  - Task: add engine mode switching to ctrl.ts
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:52:46.233Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P2`
  - Sprint task ID: `SPR-003-T08`
  - Completed at: `2026-03-31T16:50:45.038Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-574 - Persist Last Used Strength Level In LocalStorage
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 2 / Task 2.3`
  - Task: add localStorage persistence for strength level
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Reviewed at: `2026-04-01T17:52:49.886Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P2`
  - Sprint task ID: `SPR-003-T09`
  - Completed at: `2026-03-31T16:51:11.062Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-575 - Phase 2 Build Typecheck And Console Validation
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 2 / Task 2.4`
  - Task: validate Phase 2 build typecheck and console test
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:45:45.526Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P2`
  - Sprint task ID: `SPR-003-T10`
  - Completed at: `2026-03-31T16:51:26.788Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-577 - Play Move Service Phase Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-577`
  - Parent prompt ID: `CCP-564`
  - Batch prompt IDs: `CCP-578`, `CCP-579`, `CCP-580`, `CCP-581`
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 3 manager`
  - Task: execute Phase 3 child prompts in order
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Sprint task ID: `SPR-003-T11`
  - Completed at: `2026-03-31T16:53:28.399Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-578 - Design Bestmove Routing For Play Mode
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-578`
  - Parent prompt ID: `CCP-577`
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 3 / Task 3.1`
  - Task: design bestmove callback routing approach
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P3`
  - Sprint task ID: `SPR-003-T12`
  - Completed at: `2026-03-31T16:52:02.852Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-579 - Implement RequestPlayMove And CancelPlayMove
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 3 / Task 3.2`
  - Task: create playMove.ts with shared play-move service
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:53:39.922Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P3`
  - Sprint task ID: `SPR-003-T13`
  - Completed at: `2026-03-31T16:52:41.278Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-580 - Add PlayMoveWithDelay Utility
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 3 / Task 3.3`
  - Task: add move delay utility scaled by strength level
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Reviewed at: `2026-04-01T17:53:44.453Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P3`
  - Sprint task ID: `SPR-003-T14`
  - Completed at: `2026-03-31T16:53:05.054Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-581 - Phase 3 Build Typecheck And Console Integration Test
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 3 / Task 3.4`
  - Task: validate Phase 3 with console integration test
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:45:45.647Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P3`
  - Sprint task ID: `SPR-003-T15`
  - Completed at: `2026-03-31T16:53:22.323Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-582 - Practice Against Them Integration Phase Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-582`
  - Parent prompt ID: `CCP-564`
  - Batch prompt IDs: `CCP-583`, `CCP-584`, `CCP-585`, `CCP-586`
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 4 manager`
  - Task: execute Phase 4 child prompts in order
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:45:57.168Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  ...
  - Sprint task ID: `SPR-003-T16`
  - Completed at: `2026-03-31T16:56:41.153Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-583 - Add StrengthLevel To PracticeSession Type
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-583`
  - Parent prompt ID: `CCP-582`
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 4 / Task 4.1`
  - Task: add strengthLevel to PracticeSession and startPractice
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:54:28.768Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P4`
  - Sprint task ID: `SPR-003-T17`
  - Completed at: `2026-03-31T16:54:25.000Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-584 - Wire RequestPlayMove Into Practice Engine Branch
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 4 / Task 4.2`
  - Task: wire play-move service into schedulePracticeOpponentResponse
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:45:45.701Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P4`
  - Sprint task ID: `SPR-003-T18`
  - Completed at: `2026-03-31T16:55:55.555Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-585 - Update Practice Banner To Show Strength Level
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 4 / Task 4.3`
  - Task: show engine strength info in practice banner
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:54:42.274Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P4`
  - Sprint task ID: `SPR-003-T19`
  - Completed at: `2026-03-31T16:56:16.961Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-586 - Phase 4 End To End Validation
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 4 / Task 4.4`
  - Task: end-to-end validation of practice with engine strength
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:45:45.592Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P4`
  - Sprint task ID: `SPR-003-T20`
  - Completed at: `2026-03-31T16:56:34.790Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-587 - Strength Selector UI Phase Manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-587`
  - Parent prompt ID: `CCP-564`
  - Batch prompt IDs: `CCP-588`, `CCP-589`, `CCP-590`, `CCP-591`, `CCP-592`
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 5 manager`
  - Task: execute Phase 5 child prompts in order
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:55:11.941Z`
  - Reviewed by: `Codex`
  - Review method: `manager-plus-children`
  ...
  - Sprint task ID: `SPR-003-T21`
  - Completed at: `2026-03-31T16:59:17.772Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-588 - Audit Lichess AI Level Selector UI Pattern
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-588`
  - Parent prompt ID: `CCP-587`
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 5 / Task 5.1`
  - Task: research Lichess AI level selector UI
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:44:48.678Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P5`
  - Sprint task ID: `SPR-003-T22`
  - Completed at: `2026-03-31T16:57:12.200Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-589 - Create RenderStrengthSelector View Function
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 5 / Task 5.2`
  - Task: create reusable Snabbdom strength selector component
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:01:23.118Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P5`
  - Sprint task ID: `SPR-003-T23`
  - Completed at: `2026-03-31T16:57:40.251Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-590 - Embed Strength Selector In Practice Setup Panel
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 5 / Task 5.3`
  - Task: embed strength selector in practice setup panel
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Reviewed at: `2026-04-01T18:01:26.687Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P5`
  - Sprint task ID: `SPR-003-T24`
  - Completed at: `2026-03-31T16:58:11.910Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-591 - Add Strength Selector Styling
...
- [x] Reviewed
  ...
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 5 / Task 5.4`
  - Task: add responsive strength selector styles
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T18:01:32.599Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P5`
  - Sprint task ID: `SPR-003-T25`
  - Completed at: `2026-03-31T16:58:41.431Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-592 - Phase 5 Visual And Functional Validation
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md`
  - Source step: `Phase 5 / Task 5.5`
  - Task: final validation of strength selector and full sprint
  - Created by: `Claude`
  - Created at: `2026-03-31T15:34:50.820Z`
  ...
  - Reviewed at: `2026-04-01T18:01:36.211Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Sprint ID: `SPR-003`
  - Sprint phase ID: `SPR-003-P5`
  - Sprint task ID: `SPR-003-T26`
  - Completed at: `2026-03-31T16:59:11.253Z`
  - Manual checklist:
    - [ ] Verify implementation exists and builds clean
    - [ ] Verify npm run build passes
    - [ ] Verify npx tsc --noEmit passes
...
## CCP-593 - Fix retro move feedback lost after offTrack state
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `user-reported bug`
  - Source step: `Learn from your mistakes shows offTrack instead of move feedback`
  - Task: Fix retroMoveHandler after-hook gating on isSolving() so eval state is entered after a wrong move
  - Created by: `Claude`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:44:18.818Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] Open analysis board, start Learn from your mistakes
    - [ ] At exercise position, play a wrong move — confirm eval/fail feedback renders (NOT 'You browsed away')
    - [ ] At exercise position, play the correct move — confirm win feedback renders
    - [ ] Navigate away manually (click different move in list) — confirm 'You browsed away / Resume learning' still shows
    - [ ] No console errors during the above steps
```

## CCP-594 - Audit Learn from your mistakes moment selection against Lichess
...
- [x] Reviewed
  ...
  - Parent prompt ID: none
  - Batch prompt IDs: none
  - Source document: `user-reported issue`
  - Source step: `Questionable moments flagged — solution shows same move user played`
  - Task: Audit retro candidate selection, solution-move assignment, and near-best acceptance against Lichess reference
  - Created by: `Claude`
  - Created at: `2026-03-31T17:24:16.363Z`
  ...
  - Manual checklist:
    - [ ] Read audit at docs/audits/RETRO_MOMENT_SELECTION_AUDIT_2026-03-31.md
    - [ ] Verify Q1b finding: in main.ts ~line 351, confirm strictSolutionMove: node.uci (played move, not engine best)
    - [ ] Verify Q4/Q5 finding: confirm parentEval.best is shared between batch and live ceval in evalCache
    - [ ] Review ranked divergences and fix recommendations for accuracy
    - [ ] Confirm no code was changed
```

## CCP-595 - Eval diff for retro move quality — batch manager
...
- [x] Reviewed
  ...
  - Task ID: `CCP-595`
  - Parent prompt ID: none
  - Batch prompt IDs: `CCP-596`, `CCP-597`, `CCP-598`
  - Source document: `null`
  - Source step: `null`
  - Task: manager: wire eval diff display into learn from your mistakes
  - Created by: `Claude`
  ...
  - Review outcome: issues resolved
  - Review issues: none
  - Reviewed at: `2026-04-01T22:45:45.540Z`
  - Reviewed by: `Codex`
  - Review method: `follow-up-recheck`
  ...
  - Manual checklist:
    - [ ] All 3 child prompts completed: CCP-596, CCP-597, CCP-598
    - [ ] src/analyse/evalDiff.ts exists with computeEvalDiff + formatPawns
    - [ ] RetroCandidate.evalDiff populated from batch analysis loss field
    - [ ] Diff shows in win/fail/view feedback panels in retroView
    - [ ] No engine disruption during retro sessions
```

## CCP-596 - Create shared eval diff utility — src/analyse/evalDiff.ts
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-596`
  - Parent prompt ID: `CCP-595`
  - Batch prompt IDs: none
  - Source document: `null`
  - Source step: `null`
  - Task: create src/analyse/evalDiff.ts with computeEvalDiff and formatPawns
  - Created by: `Claude`
  - Created at: `2026-03-31T21:42:03.926Z`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T17:44:28.418Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] src/analyse/evalDiff.ts exists with computeEvalDiff and formatPawns exports
    - [ ] Loss-based primary path uses nodeEval.loss (mover-perspective, 0-0.5 scale)
    - [ ] CP-based path uses white-perspective convention (sign * cp for each color)
    - [ ] Mate handling returns formatted 'M3' style string
    - [ ] npm run build and tsc --noEmit both pass
    - [ ] No existing files were modified
```

## CCP-597 - Wire eval diff into RetroCandidate + silent background eval
...
- [x] Reviewed
  ...
  - Source document: `null`
  - Source step: `null`
  - Task: extend RetroCandidate with evalDiff field and wire background engine eval
  - Created by: `Claude`
  - Created at: `2026-03-31T21:42:03.926Z`
  ...
  - Reviewed at: `2026-04-01T17:44:35.151Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] RetroCandidate interface has evalDiff?: EvalDiff field
    - [ ] buildRetroCandidates populates evalDiff from evalCache at session build time
    - [ ] requestRetroBackgroundEval exported from retro.ts (refreshes from cache, never downgrades 'cp' confidence)
    - [ ] retroMoveHandler.ts calls requestRetroBackgroundEval in after-move hook before setFeedback('eval')
    - [ ] npm run build and tsc --noEmit both pass
```

## CCP-598 - Render eval diff placeholder in retroView feedback and solution panels
...
- [x] Reviewed
  ...
  - Source document: `null`
  - Source step: `null`
  - Task: display evalDiff in retroView win/fail/view feedback panels
  - Created by: `Claude`
  - Created at: `2026-03-31T21:42:03.926Z`
  ...
  - Reviewed at: `2026-04-01T17:44:42.596Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  - Review scope: leaf only
  - Skip reason: none
  ...
  - Manual checklist:
    ...
    - [ ] Solve an exercise correctly — win panel shows eval diff value (e.g. '+1.5') if diff available
    - [ ] Fail an exercise — fail panel shows eval diff value below the fail message
    - [ ] Click Show Solution — solution panel shows eval diff value below 'Best was [move]'
    - [ ] Candidates where evalDiff is absent show no diff text
    - [ ] npm run build and tsc --noEmit both pass
```
...
- [x] Reviewed
  ...
  - Source step: `Reset game-list pagination on filter changes`
  - Task: Fix Games tab pagination so changing filters resets the current page back to page 0.
  - Created by: `Codex`
  ...
  - Manual checklist:
    - [ ] Open the Games page, navigate to page 2 or later, then change a normal filter — expected result: the list resets to page 0 and shows the first filtered results
    - [ ] Change multiple filters in sequence while paging — expected result: pagination keeps returning to page 0 without console errors
    - [ ] Import or reload games after using filters — expected result: the page still behaves normally and pagination remains valid
```
...
- [x] Reviewed
  ...
  - Source step: `Extend structured loading skeletons beyond analysis-game`
  - Task: Finish the structured route-skeleton work for the async routes originally targeted by CCP-504.
  - Created by: `Codex`
  - Created at: `2026-04-01T01:20:00.000Z`
  ...
  - Manual checklist:
    - [ ] Navigate to each async route (games, puzzles, opponents, stats) during initial load — expected result: the page shell appears immediately instead of a plain Loading text state
    - [ ] Wait for async data to resolve on each route — expected result: the placeholders are replaced by the real content without layout jumps or console errors
    - [ ] Reload directly into one of the async routes — expected result: the structured skeleton still appears during initial load
```
...
- [x] Reviewed
  ...
  - Source step: `Make import progress count live instead of final-only`
  - Task: Fix import progress so visible game counts update during Lichess and Chess.com imports rather than only after completion.
  - Created by: `Codex`
  - Created at: `2026-04-01T01:20:00.000Z`
  ...
  - Manual checklist:
    - [ ] Start a Chess.com import with multiple archives — expected result: the header count increases during the import instead of only at the end
    - [ ] Start a Lichess import — expected result: the header count updates during the active import flow without waiting for the final completion state
    - [ ] Finish an import and reload the page — expected result: final import totals and normal behavior remain correct with no console errors
```
...
- [x] Reviewed
  ...
  - Source step: `Keep inactive username line empty in color toggle buttons`
  - Task: Fix the opening-tree color toggle so the inactive button keeps an empty reserved username line instead of rendering Opponents.
  - Created by: `Codex`
  - Created at: `2026-04-01T01:20:00.000Z`
  ...
  - Manual checklist:
    - [ ] Open the affected openings surface with a username loaded — expected result: only the active color button shows the username line
    - [ ] Switch between White and Black — expected result: the username moves to the active button and the inactive reserved line stays empty while both buttons remain equal height
    - [ ] Check console while toggling colors — expected result: no runtime errors
```
...
- [x] Reviewed
  ...
  - Source step: `Initialize stored strength level on module load`
  - Task: Finish strength-level persistence by initializing the active play strength from stored/default value during engine controller startup.
  - Created by: `Codex`
  - Created at: `2026-04-01T01:20:00.000Z`
  ...
  - Manual checklist:
    - [ ] Set a play strength level, reload the page, and inspect the active level — expected result: the stored level is restored immediately on load
    - [ ] Inspect localStorage for patzer.playStrengthLevel — expected result: the stored/default value is present and consistent with runtime config
    - [ ] Start a practice session after reload — expected result: the engine uses the restored strength with no console errors
```
...
- [x] Reviewed
  ...
  - Task: Fix playMoveWithDelay so canceling during the pre-send delay actually prevents later engine requests and stale callbacks.
  - Created by: `Codex`
  - Created at: `2026-04-01T01:20:00.000Z`
  ...
  - Manual checklist:
    - [ ] Start a delayed engine move request, cancel during the thinking window, and wait past the original delay — expected result: no engine request fires and no stale callback runs
    - [ ] Start a delayed engine move request without canceling — expected result: the engine request still fires after the intended delay
    - [ ] Stop or close the dependent practice flow during the delay — expected result: no stale engine move arrives and no console errors appear
```
...
- [x] Reviewed
  ...
  - Source step: `Fix practice setup copy to match immediate-start behavior`
  - Task: Correct the Practice Against Them setup copy so it matches the current behavior where color selection starts practice immediately.
  - Created by: `Codex`
  - Created at: `2026-04-01T01:20:00.000Z`
  ...
  - Manual checklist:
    - [ ] Open the practice setup panel — expected result: the copy no longer mentions a separate start button if color selection starts practice immediately
    - [ ] Click a color choice — expected result: practice starts immediately and the preceding copy accurately described that behavior
    - [ ] Check console while entering practice — expected result: no runtime errors
```
...
- [x] Reviewed
  ...
  - Task: Fix requestRetroBackgroundEval so missing or shallow retro diff data triggers a real silent one-shot eval instead of only rereading cache.
  - Created by: `Codex`
  - Created at: `2026-04-01T01:20:00.000Z`
  ...
  - Manual checklist:
    - [ ] Start Learn From Your Mistakes on a reviewed game with at least one candidate initially missing diff data — expected result: the candidate receives a real background eval and later has diff data without visible engine noise
    - [ ] Resolve a retro candidate and advance to the next one — expected result: the next candidate can trigger the silent background eval path without arrows, ceval panel changes, or extra redraw churn
    - [ ] Check console and engine behavior during the background pass — expected result: no runtime errors and no visible analysis-mode disruption
```
...
- [x] Reviewed
  ...
  - Source step: `Hide zero or negative eval diff badges`
  - Task: Fix retro eval-diff display gating so zero or negative differences render nothing.
  - Created by: `Codex`
  - Created at: `2026-04-01T01:20:00.000Z`
  ...
  - Manual checklist:
    - [ ] Solve or fail a retro candidate with a positive diff — expected result: the Diff badge still appears
    - [ ] Trigger a candidate whose diff is zero or negative — expected result: no Diff badge is rendered at all
    - [ ] Check win, fail, and view states plus the console — expected result: the display logic stays clean with no runtime errors
```
...
- [x] Reviewed
  ...
  - Task: Run the category-1 root-cause follow-up fix prompts sequentially with guarded stop-on-issue behavior.
  - Created by: `Codex`
  ...
  - Manual checklist:
    - [ ] All 10 child fix prompts (CCP-520-F1 through CCP-592-F1) are marked queued-run — expected result: visible in the dashboard pending review
    - [ ] Each original parent prompt shows reviewOutcome = issues resolved — expected result: CCP-520, CCP-580, CCP-574, CCP-597, CCP-598, CCP-503, CCP-504, CCP-505, CCP-513, CCP-592 updated
...
- [x] Reviewed
  ...
  - Task: Review the completed-but-unreviewed CCP-511 child prompts and then re-close the manager honestly.
  - Created by: `Codex`
  ...
  - Manual checklist:
    - [ ] Open Opponents page, load a collection, navigate to Prep Report — toggle Recent/All-time and verify it affects the line display
    - [ ] On Style dashboard, confirm top3EcoPct appears only once (in style axes or behavioral, not both)
    - [ ] Start a Practice session at a position where opponent data exists, confirm only player color pieces are draggable
```
...
- [x] Reviewed
  ...
  - Task: Run the pending Phase 5 study child prompts that were never executed.
  - Created by: `Codex`
  - Created at: `2026-04-01T02:30:00.000Z`
  ...
  - Manual checklist:
    - [ ] Open study → Practice this line → select color → drill session starts
    - [ ] Board shows correct orientation (user color at bottom)
    - [ ] Correct move: board flashes green, 'Correct!' shown, auto-advances after 600ms
    - [ ] Incorrect move: board flashes red, 'Try again (N left)' shown
    - [ ] After 3 failures: 'The move was X' shown, board auto-plays correct move
    - [ ] End session: drill summary shows positions quizzed, accuracy, lines completed, duration
```
...
- [x] Reviewed
  ...
  - Task: Run the pending Phase 6 study child prompts that were never executed.
  - Created by: `Codex`
  - Created at: `2026-04-01T02:30:00.000Z`
  ...
  - Manual checklist:
    - [ ] Practice dashboard shows due count and Start Review button when positions are due
    - [ ] Learn Now button appears for unlearned sequences
    - [ ] Start Review launches drill with due sequences
    - [ ] Learn mode auto-plays line then transitions to quiz
    - [ ] After learn completes, position-progress in IDB shows level=1 for all positions
    - [ ] IDB drill-attempts records appear after each graded move
```
...
- [x] Reviewed
  ...
  - Task: Run the pending Phase 7 study child prompts that were never executed.
  - Created by: `Codex`
  - Created at: `2026-04-01T02:30:00.000Z`
  ...
  - Manual checklist:
    - [ ] CCP-558: 'Practice from here' context menu item present; picker shows color-only (no scope selector)
    - [ ] CCP-559: Practice Lines panel renders in study detail with label, color, status, move count, due count, and action buttons
    - [ ] CCP-560: Scope selector (Full game / From current position / Selected variation) appears in 'Practice this line' picker but NOT in the context-menu flow
    - [ ] All three extract paths tested: full mainline, from current position, selected variation all launch drill correctly
```
...
- [x] Reviewed
  ...
  - Task: Run the category-3 process cleanup prompts for unreviewed child batches and never-executed managers.
  - Created by: `Codex`
  - Created at: `2026-04-01T02:30:00.000Z`
  ...
  - Manual checklist:
    - [ ] CCP-511-F1: 15 previously-unreviewed study Phase 5-7 child prompts reviewed and marked
    - [ ] CCP-553-F1: Phase 5 drill children (CCP-549–552) all executed — board adapter, drill view, learn mode, study detail drill integration
    - [ ] CCP-557-F1: Phase 6 scheduling/review children (CCP-554–556) all executed — scheduler, studyDb/studyCtrl data loading, library dashboard
    - [ ] CCP-561-F1: Phase 7 practice line selection children (CCP-558–560) all executed — Practice from here, Practice Lines panel, scope selector
```

## CCP-588-F1 - Backfill Durable Lichess AI Selector Audit Artifact
...
- [x] Reviewed
  ...
  - Task: Create the missing durable AI level selector audit document and add a discoverability link.
  - Created by: `Codex`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T22:44:41.463Z`
  - Reviewed by: `Codex`
  - Review method: `full-review`
  ...
  - Manual checklist:
    - [ ] Open docs/reference/LICHESS_AI_LEVEL_SELECTOR_AUDIT.md — expected: clearly records the radio-button-group pattern, source-confirmed findings distinguished from inferred, and recommended Patzer approach with CSS and Snabbdom snippets
    - [ ] Open docs/mini-sprints/ENGINE_STRENGTH_LEVELS_SPRINT_2026-03-30.md Phase 5 table — expected: CCP-588 row contains a working link to the audit document
    - [ ] Run build and typecheck — expected: both pass with no code impact
```
...
- [x] Reviewed
  ...
  - Parent prompt ID: none
  - Batch prompt IDs: none
  - Source document: `User request: dashboard.html refresh UX improvement`
  - Source step: ``
  - Task: Replace the plain alert() on Refresh button with a modal showing two side-by-side options (static rebuild and live server), each with code boxes and copy buttons
  - Created by: `Claude Code`
  ...
  - Manual checklist:
    - [ ] Open docs/prompts/dashboard.html via file:// in a browser
    - [ ] Click 'Refresh Data' — confirm modal appears (not an alert)
    - [ ] Confirm two side-by-side panels: 'Rebuild & Reload' and 'Use Live Server'
    - [ ] Click Copy next to 'npm run prompts:dashboard' — confirm clipboard copy and 'Copied!' feedback
    - [ ] Click Copy next to 'node server.mjs' — confirm copy works
    - [ ] Click Copy next to the localhost URL — confirm copy works
    - [ ] Press ESC — confirm modal closes
    - [ ] Click backdrop area outside modal — confirm modal closes
    - [ ] Click × button — confirm modal closes
    - [ ] Run 'node server.mjs' and open http://localhost:3001/docs/prompts/dashboard.html — confirm Refresh button still works in live mode (no modal)
```
...
- [x] Reviewed
  ...
  - Parent prompt ID: none
  - Batch prompt IDs: none
  - Source document: `User request: next-up view stability and urgent prompt visibility`
  - Source step: ``
  - Task: Add amber urgent callout block above the prompt table (critical/high/bugfix/typecheck queued prompts) and fix next-up sort to be stable by priority tier then createdAt descending
  - Created by: `Claude Code`
  ...
  - Manual checklist:
    - [ ] Open dashboard.html in browser, select 'Next Up' sort — confirm amber 'Needs Attention' block appears above the table
    - [ ] Confirm the block shows only queued-pending prompts that are critical, high, bugfix, or typecheck
    - [ ] Confirm each row shows status badge, CCP ID, title, and priority · category meta
    - [ ] Click an urgent row — confirm the detail panel opens for that prompt
    - [ ] Confirm the same prompts also appear in their normal position in the main table below
    - [ ] Switch to any other sort preset (e.g. ID newest first) — confirm urgent block disappears
    - [ ] Switch back to Next Up — confirm urgent block reappears
    - [ ] In the queued-pending section of the main table, confirm prompts are now sorted by priority tier (critical first, then high, then normal) and newest-first within each tier — not by ID ascending
```
...
- [x] Reviewed
  ...
  - Parent prompt ID: none
  - Batch prompt IDs: none
  - Source document: `User request: refresh button should force full page cache dump and reload`
  - Source step: ``
  - Task: After fetchLiveData() resolves in live mode, trigger a cache-busting hard reload via location.href with a timestamp query param
  - Created by: `Claude Code`
  ...
  - Manual checklist:
    - [ ] Start dev server with 'node server.mjs' and open http://localhost:3001/docs/prompts/dashboard.html
    - [ ] Click 'Refresh Data' — confirm page fully reloads (URL gains ?t=<timestamp> then page refreshes)
    - [ ] Confirm reloaded page shows current data
    - [ ] Confirm file:// modal still works (open dashboard.html directly, click Refresh — modal appears, no reload)
```
...
- [x] Reviewed
  ...
  - Parent prompt ID: none
  - Batch prompt IDs: none
  - Source document: `User request: next-up view should be flat creation order, no grouping`
  - Source step: ``
  - Task: Replace next-up sort with flat createdAt ascending (oldest first, newest at bottom), drop queue-state grouping entirely, show all prompts
  - Created by: `Claude Code`
  ...
  - Manual checklist:
    - [ ] Open dashboard at localhost, select 'Next Up' sort
    - [ ] Confirm all 659 prompts appear (not filtered by queue state)
    - [ ] Confirm CCP-1 or earliest prompts are at the top, CCP-609 is near the bottom
    - [ ] Switch to a different sort and back to Next Up — confirm order is unchanged
    - [ ] Confirm urgent block still appears for any qualifying queued-pending prompts
```
...
- [x] Reviewed
  ...
  - Parent prompt ID: none
  - Batch prompt IDs: none
  - Source document: `User request: bulk copy buttons for needs review and issues found prompt IDs`
  - Source step: ``
  - Task: Add two bulk-copy buttons to the right of the tabs bar: one copies all queued-run prompt IDs, one copies all issues-found/needs-rework prompt IDs, both as numbered comma-separated lists
  - Created by: `Claude Code`
  ...
  - Manual checklist:
    - [ ] Open dashboard, confirm two buttons appear on the right side of the Prompts/Sprints tab bar
    - [ ] Click 'Copy Needs Review IDs' — paste into text editor, confirm format '1. CCP-xxx, 2. CCP-yyy, ...'
    - [ ] Click 'Copy Issues Found IDs' — paste and confirm only issues found/needs rework prompts are listed
    - [ ] Confirm '✓ Copied!' feedback appears for 1.5s then reverts
    - [ ] If all prompts of a type are cleared, confirm button shows 'None' briefly
```
...
- [x] Reviewed
  ...
  - Parent prompt ID: none
  - Batch prompt IDs: none
  - Source document: `User request: simplified dashboard filter buttons`
  - Source step: ``
  - Task: Replace 15-filter toolbar with 7 filters: All, Managers, Ready, Started, Errors (run-errors + issues found + needs rework), Completed, Passed Review
  - Created by: `Claude Code`
  ...
  - Manual checklist:
    - [ ] Open dashboard and confirm exactly 7 filter buttons appear: All, Managers, Ready, Started, Errors, Completed, Passed Review
    - [ ] Click 'Managers' and verify only manager-kind prompts are shown
    - [ ] Click 'Errors' and verify prompts with run-errors, issues found, or needs rework are shown
    - [ ] Click 'All' and verify full prompt list is restored
    - [ ] Click 'Ready', 'Started', 'Completed', 'Passed Review' and verify each narrows correctly
```
...
- [ ] Reviewed
  ...
  - Parent prompt ID: none
  - Batch prompt IDs: none
  - Source document: `User request: AI Guided Questions mode with GUIDED_QUESTIONS_MODE snippet`
  - Source step: ``
  - Task: Add behavioral gate to CLAUDE.md requiring Claude to ask 'AI Guided Questions or Quick Create?' before every prompt/sprint creation, implement one-at-a-time question flow that bakes answers into the prompt body, update creation process docs
  - Created by: `Claude Code`
...
- [ ] Reviewed
  ...
  - Parent prompt ID: none
  - Batch prompt IDs: none
  - Source document: `User request: AI Guided Questions for sprint creation (CCP-616 companion)`
  - Source step: ``
  - Task: Extend AI Guided Questions gate to sprint creation with expanded question set covering goal, scope, phases, sequencing, validation gates, and Lichess reference; create SPRINT_CREATION_PROCESS.md
  - Created by: `Claude Code`
...
- [x] Reviewed
  ...
  - Source step: ``
  - Task: Pin Status and copy button columns in dashboard table so they remain visible at all window widths using sticky positioning
  - Created by: `Claude`
  ...
  - Manual checklist:
    - [ ] Narrow the browser window and confirm Status badge stays pinned to the right edge
    - [ ] Narrow the browser window and confirm the copy button stays pinned to the right edge
    - [ ] Hover a row and confirm background is consistent across sticky and non-sticky cells
    - [ ] Confirm manager rows have correct background on both sticky and non-sticky cells
```
...
- [x] Reviewed
  ...
  - Source document: `scripts/generate-prompt-dashboard.mjs`
  - Source step: ``
  - Task: Make dashboard header sticky so the Refresh Data button remains visible at all scroll positions
  - Created by: `Claude`
  ...
  - Manual checklist:
    - [ ] Scroll down past the first screenful and confirm the header stays pinned at the top
    - [ ] Confirm the Refresh Data button is clickable at all scroll positions
    - [ ] Confirm table rows scroll under the header without visual overlap issues
```
...
- [x] Reviewed
  ...
  - Status: `reviewed`
  - Task ID: `CCP-619`
  - Parent prompt ID: `CCP-619`
  - Batch prompt IDs: none
  - Source document: `scripts/generate-prompt-dashboard.mjs`
  - Source step: ``
  - Task: Use CSS order to keep Refresh Data button on first header row at narrow widths
  - Created by: `Claude`
  ...
  - Review outcome: passed
  - Review issues: none
  - Reviewed at: `2026-04-01T22:09:12.755Z`
  - Reviewed by: `Claude`
  - Review method: `full-review`
  - Review scope: none
  - Skip reason: none
  ...
  - Manual checklist:
    - [ ] N/A — superseded before execution
```
...
- [x] Reviewed
  ...
  - Source document: `scripts/generate-prompt-dashboard.mjs`
  - Source step: ``
  - Task: Hide .header__stats and .header__generated at narrow widths so header stays one line with Refresh button always visible
  - Created by: `Claude`
  ...
  - Manual checklist:
    - [ ] At full width header shows all elements including stats and timestamp
    - [ ] Narrow to ~400px and confirm stats and timestamp are hidden
    - [ ] Narrow to ~400px and confirm header stays on a single line
    - [ ] Narrow to ~400px and confirm Refresh button is visible and clickable
```
...
- [x] Reviewed
  ...
  - Source document: `scripts/generate-prompt-dashboard.mjs`
  - Source step: ``
  - Task: Remove header stats counters, generated timestamp, associated CSS and JS so header shows only brand, title, and Refresh button
  - Created by: `Claude`
  ...
  - Manual checklist:
    - [ ] Header shows only brand, title, and Refresh button
...
- [x] Reviewed
  ...
  - Source document: `scripts/generate-prompt-dashboard.mjs`
  - Source step: ``
  - Task: Add a 2-minute stale timer that turns the Refresh button amber when the dashboard data has not been refreshed recently
  - Created by: `Claude`
  ...
  - Manual checklist:
    - [ ] Refresh button is visibly larger and bolder than the bulk-copy buttons
...
- [x] Reviewed
  ...
  - Task: Run the tracked four-wave re-triage campaign for the old prompts still marked issues found.
  - Created by: `Codex`
...
- [x] Reviewed
  ...
  - Task: Re-triage manager prompts still marked issues found, resolving child fallout before re-closing managers.
  - Created by: `Codex`
  ...
  - Manual checklist:
    - [ ] Every Wave 2 manager prompt has a current disposition and review provenance
    - [ ] No manager was re-closed before its relevant child states were checked
    - [ ] Any newly created follow-up prompts in this wave are rooted only in real current issues
```
...
- [x] Reviewed
  ...
  - Task: Re-triage prompts whose historical issues were process, artifact, or closeout related and create follow-ups only when the gap still matters.
  - Created by: `Codex`
  ...
  - Manual checklist:
    - [ ] Every Wave 3 prompt has a current disposition and review provenance
    - [ ] Follow-up prompts were created only for still-meaningful process or artifact gaps
    - [ ] Resolved/superseded decisions are explained in review scope or notes
```
...
- [x] Reviewed
  ...
  - Task: Re-triage the recent non-manager prompts still marked issues found and create follow-up fixes only for current bugs.
  - Created by: `Codex`
  ...
  - Manual checklist:
    - [ ] Every Wave 1 prompt has one explicit disposition
    - [ ] Any new follow-up prompts are rooted only in real current bugs or still-important artifact gaps
    - [ ] Resolved and superseded prompts were re-reviewed with explicit scope and provenance
```
...
- [x] Reviewed
  ...
  - Task: Re-triage the oldest issue-marked prompts and default to superseded unless the issue still clearly matters now.
  - Created by: `Codex`
...
- [x] Reviewed
  ...
  - Source document: `ad hoc user request`
  - Source step: ``
  - Task: investigate whether the Mistake Detection Minimum Severity controls are behaving as intended, determine if the current UI is misleading or incomplete, and implement the smallest safe clarity or behavior fix if the diagnosis is clear
  - Created by: `Codex`
  ...
  - Manual checklist:
    - [ ] Open the Mistake Detection modal and switch Minimum Severity between Inaccuracy, Mistake, and Blunder; verify the intended UI feedback is clear
    - [ ] Confirm Missed Mate in N still changes value correctly and no unrelated retrospection settings regress
```
...
- [x] Reviewed
  ...
  - Task: Request top/recent games from explorer-supported DBs and keep unsupported cases honest in the explorer UI.
  - Created by: `Codex`
...
- [x] Reviewed
  ...
  - Task: Finish rated-ladder sync so authenticated users restore rating history and rated-attempt state, not just puzzle perf.
  - Created by: `Codex`
...
- [x] Reviewed
  ...
  - Batch prompt IDs: none
  - Source document: `User request: prompt dashboard filter count bug fix`
  - Source step: ``
  - Task: Fix the prompt dashboard so the active filter button label shows the number of prompts matching that filter.
  - Created by: `Codex`
  ...
  - Manual checklist:
    - [ ] Open dashboard and click 'All' — expected result: full prompt list is shown and the active All filter label shows the full matching count
    - [ ] Click 'Managers' — expected result: only manager prompts are shown and the active Managers filter label shows the correct count
