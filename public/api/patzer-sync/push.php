...
$stmt = $pdo->prepare(
    'INSERT INTO patzer_sync_items (user_key, `store`, item_key, payload_json, updated_at_ms)
     VALUES (:user_key, :store_name, :item_key, :payload_json, :updated_at_ms)
...
try {
    foreach ($items as $item) {
        ...
        $stmt->execute([
            ...
            ':updated_at_ms' => patzer_item_updated_at($item),
        ]);
...
patzer_json(200, ['ok' => true, 'counts' => $counts]);
