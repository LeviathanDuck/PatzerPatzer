// Board review glyph SVGs and badge-shape helper.
// Adapted from lichess-org/lila: ui/lib/src/game/glyphs.ts

import type { DrawShape } from '@lichess-org/chessground/draw';
import { parseUci, makeSquare, squareRank } from 'chessops/util';
import type { Glyph, TreeNodeBase } from '../tree/types';

// maximum number of glyphs to show for a given move
const maxGlyphs = 4;

export function annotationShapes(node: Pick<TreeNodeBase, 'uci' | 'san' | 'glyphs'>): DrawShape[] {
...
export const glyphToSvg: Record<string, (stackedNumber: number) => string> = {
  '?!': composeGlyph(
    '#56b4e9',
